...
#define MEDIA_DRM_EXTRACTORDEF_SUPPORT_VERSION 2
...
public:
    ...
    typedef struct {
        ...
        // drm scheme or not
        const CanHandleDrmFunc cah_handle_drm_scheme;
    } ExtractorDef;

    static const uint32_t EXTRACTORDEF_VERSION = MEDIA_DRM_EXTRACTORDEF_SUPPORT_VERSION;
