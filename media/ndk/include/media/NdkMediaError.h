...
typedef enum {
    ...
    AMEDIA_CAS_ERROR_BASE                     = -40000,
    AMEDIA_CAS_UNKNOWN                        = AMEDIA_CAS_ERROR_BASE,
    AMEDIA_CAS_NO_LICENSE                     = AMEDIA_CAS_ERROR_BASE - 1,
    AMEDIA_CAS_LICENSE_EXPIRED                = AMEDIA_CAS_ERROR_BASE - 2,
    AMEDIA_CAS_SESSION_NOT_OPENED             = AMEDIA_CAS_ERROR_BASE - 3,
    AMEDIA_CAS_DECRYPT_UNIT_NOT_INITIALIZED   = AMEDIA_CAS_ERROR_BASE - 4,
    AMEDIA_CAS_DECRYPT_ERROR                  = AMEDIA_CAS_ERROR_BASE - 5,
    AMEDIA_CAS_CANNOT_HANDLE                  = AMEDIA_CAS_ERROR_BASE - 6,
    AMEDIA_CAS_TAMPER_DETECTED                = AMEDIA_CAS_ERROR_BASE - 7,
    AMEDIA_CAS_NOT_PROVISIONED                = AMEDIA_CAS_ERROR_BASE - 8,
    AMEDIA_CAS_DEVICE_REVOKED                 = AMEDIA_CAS_ERROR_BASE - 9,
    AMEDIA_CAS_RESOURCE_BUSY                  = AMEDIA_CAS_ERROR_BASE - 10,
    AMEDIA_CAS_INSUFFICIENT_OUTPUT_PROTECTION = AMEDIA_CAS_ERROR_BASE - 11,
    AMEDIA_CAS_BAD_VALUE                      = AMEDIA_CAS_ERROR_BASE - 12,
    AMEDIA_CAS_INVALID_STATE                  = AMEDIA_CAS_ERROR_BASE - 13,
