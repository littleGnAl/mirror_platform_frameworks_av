...
extern const char* AMEDIAFORMAT_KEY_MAX_BUFFER_BATCH_OUTPUT_SIZE __INTRODUCED_IN(34);
extern const char* AMEDIAFORMAT_KEY_THRESHOLD_BUFFER_BATCH_OUTPUT_SIZE __INTRODUCED_IN(34);
