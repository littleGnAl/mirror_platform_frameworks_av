...
EXPORT const char* AMEDIAFORMAT_KEY_COMPTYPE = "cmpt";
EXPORT const char* AMEDIAFORMAT_KEY_SAMPLES_PERFRAME = "smpf";
EXPORT const char* AMEDIAFORMAT_KEY_TOTAL_FRAME = "totf";
EXPORT const char* AMEDIAFORMAT_KEY_FINAL_SAMPLE = "fsmp";
EXPORT const char* AMEDIAFORMAT_KEY_BUFFER_SIZE = "bsiz";
EXPORT const char* AMEDIAFORMAT_KEY_SUBTITLE_HEADER = "sbtl";
EXPORT const char* AMEDIAFORMAT_KEY_GROUP = "_grp";
EXPORT const char* AMEDIAFORMAT_KEY_BLOCKALIGN = "blka";
EXPORT const char* AMEDIAFORMAT_KEY_DV_PRIVATE = "dvpr";
EXPORT const char* AMEDIAFORMAT_KEY_CSD_AVCE = "avce";
EXPORT const char* AMEDIAFORMAT_KEY_CSD_HVCE = "hvce";
EXPORT const char* AMEDIAFORMAT_KEY_AUDIO_FORMAT = "afmt";
EXPORT const char* AMEDIAFORMAT_KEY_AUDIO_PROFILE = "apro";
EXPORT const char* AMEDIAFORMAT_KEY_SUPER_BLOCKALIGN = "sblk";
EXPORT const char* AMEDIAFORMAT_KEY_ENCODE_OPTIONS = "enop";
EXPORT const char* AMEDIAFORMAT_KEY_BITS_PER_FRAME = "btpf";
