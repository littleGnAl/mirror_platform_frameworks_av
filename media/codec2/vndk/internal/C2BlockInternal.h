...
struct _C2BlockFactory {
    ...
    /**
     * When the client receives a block from HAL, the client needs to mark
     * IGraphicBufferAllocator which the block might originally allocated.
     * The marked IGraphicBufferAllocator will be used from the dtor.
     * (calling Igba::deallocate to reclaim.)
     */
