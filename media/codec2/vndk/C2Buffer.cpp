...
std::shared_ptr<C2LinearBlock> _C2BlockFactory::CreateLinearBlock(
    ...
    static std::unique_ptr<C2DmaBufAllocator> sAllocator = std::make_unique<C2DmaBufAllocator>(0);

    std::shared_ptr<C2LinearAllocation> alloc;
    if (C2DmaBufAllocator::isValid(handle)) {
...
std::shared_ptr<C2LinearBlock> _C2BlockFactory::CreateLinearBlock(
    ...
    std::shared_ptr<C2LinearAllocation> alloc;
    if (C2DmaBufAllocator::isValid(cHandle)) {
