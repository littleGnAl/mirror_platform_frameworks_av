...
private:
    ...
    private:
        ...
        // For testing only
        C2ComponentFactory::CreateCodec2FactoryFunc mCreateFactory = nullptr; ///< loaded create function
        C2ComponentFactory::DestroyCodec2FactoryFunc mDestroyFactory = nullptr; ///< loaded destroy function
    };
