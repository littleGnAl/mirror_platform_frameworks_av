...
public:
    ...
    /**
     * Creates an info buffer containing a single linear block.
     *
     * \param index the parameter index of this info buffer.
     * \param block the content of the info buffer.
     *
     * \return shared pointer to the created info buffer.
     */
    static C2InfoBuffer CreateLinearBuffer(C2Param::Index index, const C2ConstLinearBlock &block);

    /**
     * Creates an info buffer containing a single graphic block.
     *
     * \param index the parameter index of this info buffer.
     * \param block the content of the info buffer.
     *
     * \return shared pointer to the created info buffer.
     */
    static C2InfoBuffer CreateGraphicBuffer(C2Param::Index index, const C2ConstGraphicBlock &block);
