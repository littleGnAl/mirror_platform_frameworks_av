 ...
 * region of interest encoding is enabled or disabled. If enabled, how RoI information is
 * communicated.
 */
 ...
 * 16x16 granularity in the form of qp offsets. While this information is optional,
 * when present, encoders MUST use QPFrame + QPOffset for quantizing the LCU
 */
...
struct C2RoIRectConfigStruct {
    C2RoIRectConfigStruct() : rect(), qpOffset(0) {}
    C2RoIRectConfigStruct(C2RectStruct rect_, int32_t offset_)
        : rect(rect_), qpOffset(offset_) {}

    C2RectStruct rect;
    int32_t qpOffset;

    DEFINE_AND_DESCRIBE_C2STRUCT(RoIRectConfig)
    C2FIELD(rect, "roi-rect")
 ...
 *
 * Critical sections are communicated as string
 * “top1,left1-bottom1,right1=offset1;top2,left2-bottom2,right2=offset2;...”
 *
 * top, left, bottom, right constitutes the vertices of a rectangle,
 * offset indicates the QPOffset to be used for quantizing the LCUs of the rectangle
 */
