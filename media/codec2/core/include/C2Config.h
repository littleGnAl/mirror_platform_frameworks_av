...
enum C2Config::profile_t : uint32_t {
    ...
    // AC4 profiles
    // corresponding to the definitions in "The MIME codecs parameter", Annex E.13
    ...
    // where bitstream_version is defined in clause 6.3.2.1.1 and presentation_version is defined
    // in clause 6.3.2.3. AC-4 stream has no explict "profile" definition. To harmonise with
    // Android, bitstream_version and presentation_version are combined to form somewhat of an
    // equivalent to "profile".
    PROFILE_AC4_0_0 = _C2_PL_AC4_BASE,          ///< AC4 Profile 00.00
    PROFILE_AC4_1_0,                            ///< AC4 Profile 01.00
    PROFILE_AC4_1_1,                            ///< AC4 Profile 01.01
    PROFILE_AC4_2_1,                            ///< AC4 Profile 02.01
    PROFILE_AC4_2_2,                            ///< AC4 Profile 02.02
};
...
enum C2Config::level_t : uint32_t {
    ...
    // found at https://www.etsi.org/deliver/etsi_ts/103100_103199/10319002/01.02.01_60/ts_10319002v010201p.pdf
    // level = 1 << mdcompat;
    // where mdcompat is defined in clause 6.3.3.2.3. The mdcompat element indicates decoder
    // systems that are compatible with an audio presentation. A decoder system with compatibility
    // level n shall be able to decode all presentations with mdcompat <= n and shall not decode
    // presentations with mdcompat > n.
