...
struct C2TunneledModeStruct {
    ...
    inline C2TunneledModeStruct(size_t flexCount, mode_t mode_, sync_type_t type, std::vector<int32_t> id)
 ...
 */
typedef C2PortParam<C2Setting, C2TunneledModeStruct, kParamIndexTunneledMode> C2PortTunneledModeSetting;
 ...
 */
typedef C2PortParam<C2Info, C2SimpleValueStruct<int64_t>, kParamIndexTunnelSystemTime> C2PortTunnelSystemTime;
