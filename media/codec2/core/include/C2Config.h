...
C2ENUM(C2Config::encrypted_info_buffer_t, uint32_t,
    EIB_DISABLED,   ///< no encrypted info buffer passing
    EIB_ENABLED,    ///< encrypted buffer passing as info buffer
)

typedef C2PortParam<C2Tuning, C2SimpleValueStruct<C2Config::encrypted_info_buffer_t>,
