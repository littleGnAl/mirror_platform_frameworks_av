...
enum C2Config::profile_t : uint32_t {
    ...
    // in clause 6.3.2.3. AC-4 codec has no explict "profile" definition. To harmonise with
    // Android, bitstream_version and presentation_version is combined to form somewhat of an
