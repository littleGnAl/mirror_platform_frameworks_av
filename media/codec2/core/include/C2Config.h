 ...
 *
 * For encoders, 0 means the encoder accepts input buffers of any size; non-zero
 * value means the encoder accepts input data of exactly this number of samples.
 */
