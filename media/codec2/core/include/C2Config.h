...
struct C2ContentColorVolumeStruct {
    int32_t cancelFlag;    ///< cancel insertion of CCV message
    int32_t persistenceFlag;    ///< persistence of CCV message
    int32_t primariesPresentFlag;    ///< validity of color primaries in this instance
    int32_t maxLuminancePresentFlag; ///< validity of max content luminance in this instance
    int32_t minLuminancePresentFlag; ///< validity of min content luminance in this instance
    int32_t avgLuminancePresentFlag; ///< validity of average content luminance in this instance
...
struct C2HdrStaticMetadataStruct {
    ...
    int32_t hdrType; ///< type1 or type2 HDR static metadata
    int32_t validFields; ///< specifies presence of different metadata
