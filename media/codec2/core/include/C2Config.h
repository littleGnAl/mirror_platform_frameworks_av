...
constexpr char C2_PARAMKEY_HDR_STATIC_METADATA_INFO[] = "raw.hdr-static-info";

/**
 * HDR10+ Metadata Info.
 *
 * Deprecated. Use C2StreamHdrDynamicInfo with
...
constexpr char C2_PARAMKEY_INPUT_HDR_DYNAMIC_METADATA_INFO[] = "input.hdr-dynamic-info";
constexpr char C2_PARAMKEY_OUTPUT_HDR_DYNAMIC_METADATA_INFO[] = "output.hdr-dynamic-info";
