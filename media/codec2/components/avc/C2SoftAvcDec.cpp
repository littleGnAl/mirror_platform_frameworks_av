...
public:
    explicit IntfImpl(const std::shared_ptr<C2ReflectorHelper> &helper)
        ...
        addParameter(
                ...
                .withFields({
                    C2F(mC2HdrStaticInfo, hdrType).inRange(0, 1),
...
bool C2SoftAvcDec::getHDRStaticParams(ivd_video_decode_op_t *ps_decode_op,
    ...
    if (0 != memcmp(&mHdrStaticInfo.sType2, &mHdrStaticInfoLocal.sType2,
                    sizeof(HDRStaticInfo::kType2))) {
