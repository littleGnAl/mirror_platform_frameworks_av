...
bool C2SoftAvcDec::getHDRStaticParams(ivd_video_decode_op_t *ps_decode_op,
    ...
    // Assign parameters in respective fields
    {
        ...
        //Convert HDRStaticInfo to C2StreamHdrStaticInfo
        {
            ...
            c2HdrStaticInfo.mastering.red.x = mHdrStaticInfo.sType1.mR.x * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.red.y = mHdrStaticInfo.sType1.mR.y * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.green.x = mHdrStaticInfo.sType1.mG.x * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.green.y = mHdrStaticInfo.sType1.mG.y * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.blue.x = mHdrStaticInfo.sType1.mB.x * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.blue.y = mHdrStaticInfo.sType1.mB.y * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.white.x = mHdrStaticInfo.sType1.mW.x * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.white.y = mHdrStaticInfo.sType1.mW.y * kNormDispPrimaries;
            c2HdrStaticInfo.mastering.maxLuminance = mHdrStaticInfo.sType1.mMaxDisplayLuminance;
            c2HdrStaticInfo.mastering.minLuminance =
                    mHdrStaticInfo.sType1.mMinDisplayLuminance * kNormDispLuminance;
