...
bool C2SoftAvcDec::getMDCV(C2StreamHdrStaticInfo::output *hdrStaticInfo) {
    ...
    hdrStaticInfo->mastering.green.x = s_mdcv_op.au2_display_primaries_x[0] * 0.00002;
    hdrStaticInfo->mastering.blue.x = s_mdcv_op.au2_display_primaries_x[1] * 0.00002;
    hdrStaticInfo->mastering.red.x = s_mdcv_op.au2_display_primaries_x[2] * 0.00002;
    hdrStaticInfo->mastering.green.y = s_mdcv_op.au2_display_primaries_y[0] * 0.00002;
    hdrStaticInfo->mastering.blue.y = s_mdcv_op.au2_display_primaries_y[1] * 0.00002;
    hdrStaticInfo->mastering.red.y = s_mdcv_op.au2_display_primaries_y[2] * 0.00002;
    hdrStaticInfo->mastering.white.x = s_mdcv_op.u2_white_point_x * 0.00002;
    hdrStaticInfo->mastering.white.y = s_mdcv_op.u2_white_point_y * 0.00002;
    // conversion to cd/m^2
    hdrStaticInfo->mastering.maxLuminance = (s_mdcv_op.u4_max_display_mastering_luminance / 10000);
    hdrStaticInfo->mastering.minLuminance = (s_mdcv_op.u4_min_display_mastering_luminance / 10000);

    return true;
}

bool C2SoftAvcDec::getCLL( C2StreamHdrStaticInfo::output *hdrStaticInfo) {
    WORD32 ret = IV_SUCCESS;
    ...
    hdrStaticInfo->maxCll = s_cll_op.u2_max_content_light_level;
    hdrStaticInfo->maxFall = s_cll_op.u2_max_pic_average_light_level;
    return true;
}
...
void C2SoftAvcDec::getHDRStaticParams(ivd_video_decode_op_t *ps_decode_op) {
    ...
    //memset(&hdrStaticInfo, 0, sizeof(HDRStaticInfo));
    ...
    //Convert C2StreamHdrStaticInfo to C2StreamHdrStaticMetadataInfo
    C2StreamHdrStaticMetadataInfo::output c2HdrStaticInfo;
    c2HdrStaticInfo.mastering.red.x = hdrStaticInfo.mastering.red.x;
    c2HdrStaticInfo.mastering.red.y = hdrStaticInfo.mastering.red.y;
    c2HdrStaticInfo.mastering.green.x = hdrStaticInfo.mastering.green.x;
    c2HdrStaticInfo.mastering.green.y = hdrStaticInfo.mastering.green.y;
    c2HdrStaticInfo.mastering.blue.x = hdrStaticInfo.mastering.blue.x;
    c2HdrStaticInfo.mastering.blue.y = hdrStaticInfo.mastering.blue.y;
    c2HdrStaticInfo.mastering.white.x = hdrStaticInfo.mastering.white.x;
    c2HdrStaticInfo.mastering.white.y = hdrStaticInfo.mastering.white.y;
    c2HdrStaticInfo.mastering.maxLuminance = hdrStaticInfo.mastering.maxLuminance;
    c2HdrStaticInfo.mastering.minLuminance = hdrStaticInfo.mastering.minLuminance;
    c2HdrStaticInfo.maxCll = hdrStaticInfo.maxCll;
    c2HdrStaticInfo.maxFall = hdrStaticInfo.maxFall;
