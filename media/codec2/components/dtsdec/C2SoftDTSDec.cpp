...
public:
    explicit IntfImpl(const std::shared_ptr<C2ReflectorHelper> &helper)
        ...
        addParameter(
                ...
                .withDefault(new C2StreamChannelCountInfo::output(0u, DTS_DEC_DEFAULT_CHANNEL_COUNT))
        ...
        addParameter(
                ...
                .withDefault(new C2StreamDrcCompressionModeTuning::input(0u, C2Config::DRC_COMPRESSION_MEDIUM))
                .withFields({
        ...
        addParameter(
                ...
                .withDefault(new C2StreamDtsDrcEffectTypeTuning::input(0u, C2Config::DTS_DRC_EFFECT_UHD_MEDIUM_DRC_SYMMETRICAL))
                .withFields({
        ...
        addParameter(
                ...
                .withDefault(new C2StreamDtsDrcLoudnessNormStatusTuning::input(0u, C2Config::DTS_DRC_LOUDNESS_NORM_ON))
        ...
        addParameter(
                ...
                .withDefault(new C2StreamDrcTargetReferenceLevelTuning::input(0u, DTS_DEC_DRC_DEFAULT_REF_LEVEL))
        ...
        addParameter(
                ...
                .withDefault(new C2StreamDtsLimiterTypeTuning::input(0u, C2Config::DTS_HYBRID_LIMITER_UN_LINKED))
        ...
        addParameter(
                ...
                .withDefault(new C2StreamDtsOutputLayoutTuning::input(0u, C2Config::DTS_SPEAKER_LAYOUT_5P1))
    ...
    int32_t getDrcEnableFlag() const { return mDrcCompressMode->value == C2Config::DRC_COMPRESSION_NONE ? 0 : 1; }
