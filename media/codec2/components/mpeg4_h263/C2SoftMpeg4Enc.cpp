...
class C2SoftMpeg4Enc::IntfImpl : public SimpleInterface<void>::BaseParams {
   public:
...
#ifdef MPEG4
            { LEVEL_MP4V_0, 380160, 176, 144, 15, 64000 },
            { LEVEL_MP4V_1, 380160, 176, 144, 15, 128000 },
            { LEVEL_MP4V_2, 1520640, 352, 288, 30, 128000 },
#else
    ...
    ProfileLevelType getProfileLevel_l() const {
        ...
        else if (mProfileLevel->level == LEVEL_MP4V_2) return SIMPLE_PROFILE_LEVEL2;
#endif
        return SIMPLE_PROFILE_LEVEL2;
    }
