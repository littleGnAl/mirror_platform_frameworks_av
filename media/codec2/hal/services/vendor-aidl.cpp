...
//#define LOG_NDEBUG 0
#define LOG_TAG "android.hardware.media.c2-V1-service"
...
// "android.hardware.media.c2-V1-default-seccomp_policy" in Android.bp.
static constexpr char kBaseSeccompPolicyPath[] =
        "/vendor/etc/seccomp_policy/"
        "android.hardware.media.c2-V1-default-seccomp_policy";

// Additional seccomp permissions can be added in this file.
// This file does not exist by default.
static constexpr char kExtSeccompPolicyPath[] =
        "/vendor/etc/seccomp_policy/"
        "android.hardware.media.c2-V1-extended-seccomp_policy";
...
int main(int /* argc */, char** /* argv */) {
    ...
    LOG(DEBUG) << "android.hardware.media.c2-V1-service starting...";
