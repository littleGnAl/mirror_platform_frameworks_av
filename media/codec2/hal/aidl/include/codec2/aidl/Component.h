...
struct Component : public BnComponent,
    ...
    virtual ::ndk::ScopedAStatus queue(const WorkBundle& workBundle) override;
    virtual ::ndk::ScopedAStatus flush(WorkBundle *workBundle) override;
    virtual ::ndk::ScopedAStatus drain(bool withEos) override;
    virtual ::ndk::ScopedAStatus setDecoderOutputAllocator(
            const std::shared_ptr<IGraphicBufferAllocator>& allocator) override;
    virtual ::ndk::ScopedAStatus createBlockPool(
            int32_t allocatorId,
            IComponent::BlockPool *blockPool) override;
    virtual ::ndk::ScopedAStatus destroyBlockPool(int64_t blockPoolId) override;
    virtual ::ndk::ScopedAStatus start() override;
    virtual ::ndk::ScopedAStatus stop() override;
    virtual ::ndk::ScopedAStatus reset() override;
    virtual ::ndk::ScopedAStatus release() override;
    virtual ::ndk::ScopedAStatus getInterface(
            std::shared_ptr<IComponentInterface> *intf) override;
    virtual ::ndk::ScopedAStatus configureVideoTunnel(
            int32_t avSyncHwId,
