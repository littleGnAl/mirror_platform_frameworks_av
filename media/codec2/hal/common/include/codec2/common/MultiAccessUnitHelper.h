...
protected:
    ...
    /*
     * Gets Sample rate and Channel count info from the component.
     */
    void getSampleRateAndChannelCount(
            uint32_t &sampleRate, uint32_t &channelCount_);

    bool mInit;

    // Interface of this module
    std::shared_ptr<MultiAccessUnitInterface> mInterface;
    // Interface of the wrapping component
    std::shared_ptr<C2ComponentInterface> mComponentInterface;
