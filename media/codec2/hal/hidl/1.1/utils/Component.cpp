...
#include <codec2/common/MultiAccessUnitHandler.h>
...
using ::android::MultiAccessUnitHandler;
...
Component::Component(
    ...
    if (MultiAccessUnitHandler::isEnabledOnPlatform()) {
...
Return<Status> Component::queue(const WorkBundle& workBundle) {
    ...
    if (mMultiAccessUnitHdl) {
        ...
        mMultiAccessUnitHdl->scatter(c2works, &c2worklists);
...
Return<void> Component::flush(flush_cb _hidl_cb) {
    ...
    c2_status_t c2res = mComponent->flush_sm(
            ...
            &c2flushedWorks);
    if (mMultiAccessUnitHdl) {
        c2res = mMultiAccessUnitHdl->flush(&c2flushedWorks);
    }
