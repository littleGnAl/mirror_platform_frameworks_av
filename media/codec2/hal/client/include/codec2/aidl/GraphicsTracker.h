...
public:
     ...
     *
     * @param[out]  pipeFd      a file desciptor created from pipe2()
...
private:
    ...
    // an allocate/dequeue event is being happen.
    //
    ...
    // use ::poll() to check whethere there is a buffer to allocate/dequeue is
    // ready. Also ::poll() will let remote processes know the end-of-lifecycle
