...
using aidl::android::hardware::media::c2::IGraphicBufferAllocator;
...
public:
     ...
     */
    bool configure(const ::android::sp<IGraphicBufferProducer>& igbp,
                   uint32_t generation,
     ...
     *
     * @param   maxDequeueCount   Inital max allocatable count
     */
