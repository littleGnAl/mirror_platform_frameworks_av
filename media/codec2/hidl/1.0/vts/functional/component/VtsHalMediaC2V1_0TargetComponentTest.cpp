...
<<<<<<< TARGET BRANCH (c76f7e Merge "Add HwModule::getRoutes method" into android12-tests-)
...
>>>>>>> SOURCE BRANCH (87bcb2 Merge "VTS: Disable codec2 tests if platform does not suppor)
    if (isNullBuffer)
