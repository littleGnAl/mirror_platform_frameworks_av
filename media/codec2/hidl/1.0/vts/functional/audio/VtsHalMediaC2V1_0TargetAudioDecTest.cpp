...
TEST_P(Codec2AudioDecDecodeTest, DecodeTest) {
    ...
    if (mMime.find("raw") != std::string::npos) {
        ...
        bitStreamInfo[1] = 1;
<<<<<<< TARGET BRANCH (e515be Merge changes from topic "am-208ccb4d2c5f4da6ac3d16c684d6bdf)
...
>>>>>>> SOURCE BRANCH (b67721 Merge "Merge "Merge "Merge "force g711 test to match 1-chann)
