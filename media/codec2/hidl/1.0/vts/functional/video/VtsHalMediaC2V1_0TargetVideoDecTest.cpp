...
<<<<<<< TARGET BRANCH (8cce70 Merge "Merge "force g711 test to match 1-channel sample data)
        mComponent->query({&secureModeTuning}, {}, C2_MAY_BLOCK, nullptr);
=======
        mComponent->query({ &secureModeTuning }, {}, C2_MAY_BLOCK, nullptr);
>>>>>>> SOURCE BRANCH (f0463a Merge "Skip secure decoders in C2 VTS" into android10-tests-)
