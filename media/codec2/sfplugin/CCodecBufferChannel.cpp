...
status_t CCodecBufferChannel::start(
    ...
    C2EncryptedInfoBufferTuning infoBufferTuning(C2Config::EIB_DISABLED);
    ...
    mEncryptedInfoBuffer = infoBufferTuning == C2Config::EIB_DISABLED ? false : true;
