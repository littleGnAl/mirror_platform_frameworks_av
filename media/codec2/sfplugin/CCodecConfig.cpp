...
void CCodecConfig::initializeStandardParams() {
    ...
    add(ConfigMapper("android._num-input-buffers", C2_PARAMKEY_BUFFER_NUM, "inputBufferNum")
        .limitTo((D::VIDEO | D::IMAGE) & D::INPUT));
    add(ConfigMapper("android._num-output-buffers", C2_PARAMKEY_BUFFER_NUM, "outputBufferNum")
        .limitTo((D::VIDEO | D::IMAGE) & D::INPUT));
