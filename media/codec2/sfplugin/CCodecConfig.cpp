...
void CCodecConfig::initializeStandardParams() {
    ...
    add(ConfigMapper(KEY_HDR10_PLUS_INFO, C2_PARAMKEY_INPUT_HDR_DYNAMIC_INFO, "type")
        .limitTo(D::VIDEO & D::PARAM & D::INPUT)
        .withMapper([](C2Value) -> C2Value {
            return C2Config::HDR_DYNAMIC_METADATA_TYPE_SMPTE_2094_40;
        }));
    add(ConfigMapper(KEY_HDR10_PLUS_INFO, C2_PARAMKEY_INPUT_HDR_DYNAMIC_INFO, "data")
        .limitTo(D::VIDEO & D::PARAM & D::INPUT));

    add(ConfigMapper(KEY_HDR10_PLUS_INFO, C2_PARAMKEY_OUTPUT_HDR_DYNAMIC_INFO, "type")
        .limitTo(D::VIDEO & D::OUTPUT)
        .withMapper([](C2Value) -> C2Value {
            return C2Config::HDR_DYNAMIC_METADATA_TYPE_SMPTE_2094_40;
        }));
    add(ConfigMapper(KEY_HDR10_PLUS_INFO, C2_PARAMKEY_OUTPUT_HDR_DYNAMIC_INFO, "data")
        .limitTo(D::VIDEO & D::OUTPUT));
