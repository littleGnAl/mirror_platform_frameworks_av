...
C2Color::matrix_t gDefMatrix = C2Color::MATRIX_BT601;
C2Color::range_t gDefRange = C2Color::RANGE_LIMITED;
...
status_t ConvertRGBToPlanarYUV(
    ...
    // set default color space as bt.601
    if (colorMatrix != C2Color::MATRIX_BT709 && colorMatrix != C2Color::MATRIX_BT601) {
        colorMatrix = C2Color::MATRIX_BT601;
    }
