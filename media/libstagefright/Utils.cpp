...
static const struct mime_conv_t mimeLookup[] = {
    ...
    { MEDIA_MIMETYPE_AUDIO_VND_DTS,                AUDIO_FORMAT_DTS},
    { MEDIA_MIMETYPE_AUDIO_VND_DTSHD,              AUDIO_FORMAT_DTS_HD},
    { MEDIA_MIMETYPE_AUDIO_VND_DTSHD_PROFILE_MA,   AUDIO_FORMAT_DTS_HD},
    { MEDIA_MIMETYPE_AUDIO_VND_DTSHD_PROFILE_LBR,  AUDIO_FORMAT_DTS_HD},
    { MEDIA_MIMETYPE_AUDIO_VND_DTSUHD_PROFILE_P1,  AUDIO_FORMAT_DTS_HD},
    { MEDIA_MIMETYPE_AUDIO_VND_DTSUHD_PROFILE_P2,  AUDIO_FORMAT_DTS_HD}, 
