...
inline constexpr char KEY_MAX_BUFFER_BATCH_OUTPUT_SIZE[] = "max-buffer-batch-output-size";
inline constexpr char KEY_THRESHOLD_BUFFER_BATCH_OUTPUT_SIZE[] = "threshold-buffer-batch-output-size";
