...
constexpr char KEY_DTS_DRC_ATTENUATION_FACTOR_MAIN[] = "dts-drc-attenuation-factor-main";
constexpr char KEY_DTS_DRC_ATTENUATION_FACTOR_TRANSCODE[] = "dts-drc-attenuation-factor-transcode";
constexpr char KEY_DTS_DRC_BOOST_FACTOR_MAIN[] = "dts-drc-boost-factor-main";
constexpr char KEY_DTS_DRC_BOOST_FACTOR_TRANSCODE[] = "dts-drc-boost-factor-transcode";
constexpr char KEY_DTS_DRC_EFFECT_TYPE_MAIN[] = "dts-drc-effect-type-main";
constexpr char KEY_DTS_DRC_EFFECT_TYPE_TRANSCODE[] = "dts-drc-effect-type-transcode";
constexpr char KEY_DTS_DRC_MODE_MAIN[] = "dts-drc-mode-main";
constexpr char KEY_DTS_DRC_MODE_TRANSCODE[] = "dts-drc-mode-transcode";
constexpr char KEY_DTS_LIMITER_TYPE_MAIN[] = "dts-limiter-type-main";
constexpr char KEY_DTS_LIMITER_TYPE_TRANSCODE[] = "dts-limiter-type-transcode";
constexpr char KEY_DTS_LOUDNESS_NORM_ENABLE_MAIN[] = "dts-loudness-norm-enable-main";
constexpr char KEY_DTS_LOUDNESS_NORM_ENABLE_TRANSCODE[] = "dts-loudness-norm-enable-transcode";
constexpr char KEY_DTS_TARGET_LOUDNESS_MAIN[] = "dts-target-loudness-main";
constexpr char KEY_DTS_TARGET_LOUDNESS_TRANSCODE[] = "dts-target-loudness-transcode";
