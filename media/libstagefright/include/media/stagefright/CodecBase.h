...
struct CodecBase : public AHandler, /* static */ ColorUtils {
     ...
     */
    virtual status_t querySupportedParameters(std::vector<std::string> *names __unused) {
    ...
    virtual status_t describeParameter(
            const std::string &name __unused, CodecParameterDescriptor *desc __unused) {
        return ERROR_UNSUPPORTED;
    }
    /**
     ...
     *         ERROR_UNSUPPORTED if not supported.
     */
    virtual status_t subscribeToParameters(const std::vector<std::string> &names __unused) {
        return ERROR_UNSUPPORTED;
    }
    /**
     ...
     *         ERROR_UNSUPPORTED if not supported.
     */
    virtual status_t unsubscribeFromParameters(const std::vector<std::string> &names __unused) {
        return ERROR_UNSUPPORTED;
    }
