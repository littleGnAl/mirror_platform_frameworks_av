...
enum {
    ...
    // DVB component tag
    kKeyDvbComponentTag = 'dvct', // int32_t, component tag for DVB video/audio/subtitle

    // DVB audio description
    kKeyDvbAudioDescription = 'dvat', // bool (int32_t), DVB audio description only defined for
                                   // audio component
};
