...
ARTPAssembler::AssemblyStatus AAVCAssembler::addNALUnit(
    ...
    /**
     * The static jitter can be our desire merely by a dominance state of network.
     * So rebalance jitter time as like dynamic jitter.
     * Expecting rage : 50ms ~ 150ms (Not to over 300 ms practically)
     */
