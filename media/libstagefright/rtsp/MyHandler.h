...
// a new sequence.
static int32_t kMaxAllowedStaleAccessAudioUnits = 20;
static int32_t kMaxAllowedStaleAccessVideoUnits = 400;
...
static int32_t GetMaxAllowedStaleCount(bool isVideo) {
    return isVideo ? kMaxAllowedStaleAccessVideoUnits : kMaxAllowedStaleAccessAudioUnits;
}
