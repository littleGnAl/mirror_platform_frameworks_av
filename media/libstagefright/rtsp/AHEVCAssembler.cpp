...
inline int64_t AHEVCAssembler::MsToRtp(int64_t ms, int64_t clockRate) {
    return ms * clockRate / 1000;
}

inline int64_t AHEVCAssembler::RtpToMs(int64_t rtp, int64_t clockRate) {
    return rtp * 1000 / clockRate;
}

inline void AHEVCAssembler::printNowTimeMs(int64_t start, int64_t now, int64_t play) {
