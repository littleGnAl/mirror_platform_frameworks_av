...
int64_t kMaxInt64 = 0x7FFFFFFFFFFFFFFF;
...
bool VideoFrameSchedulerBase::PLL::fit(
    ...
    for (size_t i = 0; i < numSamplesToUse; i++) {
        ...
        if (sumYY > kMaxInt64 - y * y ||
                sumXX > kMaxInt64 - x * x ||
                (x * y > 0 && sumXY > kMaxInt64 - x * y) ||
                (x * y < 0 && sumXY < -kMaxInt64 - x * y)) {
    ...
    if (((sumXX != 0) && ((int64_t)numSamplesToUse > kMaxInt64 / sumXX)) ||
            ((sumX != 0) && (sumX > kMaxInt64 / sumX)) ||
            ((sumXY != 0) && ((int64_t)numSamplesToUse > kMaxInt64 / sumXY)) ||
            ((sumY != 0) && (sumX > kMaxInt64 / sumY)) ||
            ((sumY != 0) && (sumXX > kMaxInt64 / sumY)) ||
            ((sumXY != 0) && (sumX > kMaxInt64 / sumXY))) {
        ALOGE("%d line would overflow", __LINE__);
        return false;
    }
    ...
    *b = divRound(b_nom, div);
    if (((sumXY != 0) && (a_nom > kMaxInt64 / sumXY)) ||
            ((sumY != 0) && (b_nom > kMaxInt64 / sumY))) {
        ALOGE("%d line would overflow", __LINE__);
        return false;
    }
