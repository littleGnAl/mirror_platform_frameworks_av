...
TEST_P(ID3albumArtTest, AlbumArtTest) {
    ...
    if (albumArtPresent) {
        ...
        ASSERT_TRUE(data) << "Expected album art, found none!" << path;
    } else {
        ASSERT_FALSE(data) << "Found album art when expected none!";
    }
#ifdef LOG_NDEBUG
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(make_pair("bbb_44100hz_2ch_128kbps_mp3_30sec.mp3", 4),
                          ...
                          make_pair("bbb_44100hz_2ch_128kbps_mp3_5mins_largeSize.mp3", 2),
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(make_pair("bbb_44100hz_2ch_128kbps_mp3_30sec.mp3", 1),
                          ...
                          make_pair("bbb_44100hz_2ch_128kbps_mp3_5mins_largeSize.mp3", 6),
                          make_pair("bbb_44100hz_2ch_128kbps_mp3_30sec_moreTextFrames.mp3", 3)));
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(make_pair("bbb_44100hz_2ch_128kbps_mp3_30sec.mp3", false),
                          ...
                          make_pair("bbb_44100hz_2ch_128kbps_mp3_5mins_largeSize.mp3", false)));
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(make_pair("bbb_44100hz_2ch_128kbps_mp3_30sec_2_image.mp3", 2),
                          ...
                          make_pair("bbb_44100hz_2ch_128kbps_mp3_5mins_largeSize.mp3", 0)));
