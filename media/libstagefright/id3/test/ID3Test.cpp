...
TEST_P(ID3versionTest, VersionTest) {
    ...
    ASSERT_EQ(version.first, majorVersionNumber) << "Expected major version: " << majorVersionNumber
                                                 << " Found major version: " << version.first;

    ASSERT_EQ(version.second, minorVersionNumber)
            << "Expected minor version: " << minorVersionNumber
            << " Found minor version: " << version.second;
}
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                make_tuple("bbb_44100hz_2ch_128kbps_1sec_v23.mp3", 2, 3),
                ...
                make_tuple("bbb_44100hz_2ch_128kbps_2sec_v24_unsynchronizedOneFrame.mp3", 2, 4),
                make_tuple("bbb_44100hz_2ch_128kbps_2sec_v24_unsynchronizedAllFrames.mp3", 2, 4)));
