...
class MetaDataSanity {
  public:
    MetaDataSanity() : mInputBuffer(nullptr) {}
    ...
    void SetUpMetaDataSanity(string fileName) {
        struct stat buf;
...
class AvcCSDSanityTest : public MetaDataSanity,
                         public ::testing::TestWithParam<string /*inputFile*/> {
  public:
    virtual void SetUp() override {
        string inputFile = gEnv->getRes() + GetParam();

        ASSERT_NO_FATAL_FAILURE(SetUpMetaDataSanity(inputFile));
    }
};
...
class AacCSDSanityTest : public MetaDataSanity,
                         public ::testing::TestWithParam<string /*inputFile*/> {
  public:
    virtual void SetUp() override {
        string inputFile = gEnv->getRes() + GetParam();
...
class VorbisTest : public ::testing::TestWithParam<pair<string /*fileName*/, string /*infoFile*/>> {
  public:
    virtual void SetUp() override {
        string inputMediaFile = gEnv->getRes() + GetParam().first;
        ...
        string inputInfoFile = gEnv->getRes() + GetParam().second;
...
TEST_P(AvcCSDSanityTest, AvcSanityTest) {
    AMediaFormat *csdData = AMediaFormat_new();
    ASSERT_NE(csdData, nullptr) << "Failed to create AMedia format";
...
TEST_P(AacCSDSanityTest, AacSanityTest) {
    MetaDataBase *metaData = new MetaDataBase();
    ASSERT_NE(metaData, nullptr) << "Failed to create meta data";
...
INSTANTIATE_TEST_SUITE_P(MetaDataUtilsTestAll, AvcCSDSanityTest,
...
INSTANTIATE_TEST_SUITE_P(MetaDataUtilsTestAll, AacCSDSanityTest,
