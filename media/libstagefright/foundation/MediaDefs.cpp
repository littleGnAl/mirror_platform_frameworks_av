...
const char *MEDIA_MIMETYPE_VIDEO_DIVX5 = "video/divx5";
const char *MEDIA_MIMETYPE_VIDEO_DIVX_AVC = "video/divx-avc";
const char *MEDIA_MIMETYPE_VIDEO_DIVX_HEVC = "video/divx-hevc";
const char *MEDIA_MIMETYPE_VIDEO_REAL_VIDEO = "video/vnd.rn-realvideo";
