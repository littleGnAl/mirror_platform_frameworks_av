...
constexpr char kKeyHDRStaticInfo[] = "hdr-static-info";
constexpr char kKeyColorRange[] = "color-range";
constexpr char kKeyColorStandard[] = "color-standard";
constexpr char kKeyColorTransfer[] = "color-transfer";
const size_t kHDRBufferSize = 25;
const uint16_t kUint16_Value1 = 420;
const uint16_t kUint16_Value2 = 42069;
...
TEST_P(ColorRangeTest, ToStringTest) {
...
TEST_P(ColorTransferTest, ToStringTest) {
...
TEST_P(ColorAspectsTest, ToStringTest) {
...
TEST_P(DataSpaceTest, DataSpaceTest) {
    ...
    ASSERT_TRUE(status) << "Returned dataspace is not aspect-only";
...
TEST(ColorUtilsUnitTest, AspectsChangedTest) {
    ...
    ASSERT_FALSE(status) << "ColorAspects comparision check failed";

    aspects.mRange = CA::Range::RangeLimited;
    status = ColorUtils::checkIfAspectsChangedAndUnspecifyThem(aspects, origAspects);
    ASSERT_TRUE(status) << "ColorAspects comparision check failed";
...
TEST(ColorUtilsUnitTest, ColorConfigFromFormatTest) {
    ...
    format->setInt32(kKeyColorRange, CA::Range::RangeFull);
    format->setInt32(kKeyColorStandard, CA::Standard::StandardBT709);
    format->setInt32(kKeyColorTransfer, CA::Transfer::TransferLinear);
    ColorUtils::getColorConfigFromFormat(format, &range, &standard, &transfer);
    ...
    bool status = copyFormat->findInt32(kKeyColorRange, &range);
    status &= copyFormat->findInt32(kKeyColorStandard, &standard);
    status &= copyFormat->findInt32(kKeyColorTransfer, &transfer);
    ASSERT_TRUE(status) << "ColorConfig entries missing";
    EXPECT_EQ(range, CA::Range::RangeFull) << "range mismatch";
    EXPECT_EQ(standard, CA::Standard::StandardBT709) << "standard mismatch";
...
TEST(ColorUtilsUnitTest, HDRStaticInfoTest) {
    ...
    infoHDR.sType1.mMaxDisplayLuminance = kUint16_Value2;
    infoHDR.sType1.mMinDisplayLuminance = kUint16_Value1;
    infoHDR.sType1.mMaxContentLightLevel = kUint16_Value2;
    infoHDR.sType1.mMaxFrameAverageLightLevel = kUint16_Value1;
    infoHDR.sType1.mR.x = kUint16_Value1;
    infoHDR.sType1.mR.y = kUint16_Value2;
    infoHDR.sType1.mG.x = kUint16_Value1;
    infoHDR.sType1.mG.y = kUint16_Value2;
    infoHDR.sType1.mB.x = kUint16_Value1;
    infoHDR.sType1.mB.y = kUint16_Value2;
    infoHDR.sType1.mW.x = kUint16_Value1;
    infoHDR.sType1.mW.y = kUint16_Value2;
    ...
    EXPECT_EQ(returnedInfoHDR.mID, infoHDR.mID) << "ID mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mMaxDisplayLuminance, kUint16_Value2)
            << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mMinDisplayLuminance, kUint16_Value1)
            << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mMaxContentLightLevel, kUint16_Value2)
            << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mMaxFrameAverageLightLevel, kUint16_Value1)
            << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mR.x, kUint16_Value1) << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mR.y, kUint16_Value2) << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mG.x, kUint16_Value1) << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mG.y, kUint16_Value2) << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mB.x, kUint16_Value1) << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mB.y, kUint16_Value2) << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mW.x, kUint16_Value1) << " HDRStaticInfo mismatch";
    EXPECT_EQ(returnedInfoHDR.sType1.mW.y, kUint16_Value2) << " HDRStaticInfo mismatch";
...
TEST(ColorUtilsUnitTest, SanityTest) {
    ...
    format->setBuffer(kKeyHDRStaticInfo, invalidSizeHDRInfoBuffer);
    ...
    *data = HDRStaticInfo::kType1 + 1;
    format->setBuffer(kKeyHDRStaticInfo, invalidHDRInfoBuffer);
    boolStatus = ColorUtils::getHDRStaticInfoFromFormat(format, &hdrInfo);
    EXPECT_FALSE(boolStatus) << "incorrect HDRStaticInfo buffer accepted";

    format->setInt32(kKeyColorRange, ColorUtils::kColorRangeVendorStart + CA::RangeOther + 1);
    format->setInt32(kKeyColorStandard, CA::Standard::StandardBT709);
    format->setInt32(kKeyColorTransfer, CA::Transfer::TransferLinear);
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                ...
                std::make_pair(CA::Primaries::PrimariesBT709_5, CA::MatrixCoeffs::MatrixBT709_5),
                ...
                std::make_pair(CA::Primaries::PrimariesBT2020, CA::MatrixCoeffs::MatrixBT2020),
                std::make_pair(CA::Primaries::PrimariesBT2020,
                               CA::MatrixCoeffs::MatrixBT2020Constant),
                std::make_pair(CA::Primaries::PrimariesBT470_6M, CA::MatrixCoeffs::MatrixBT470_6M),
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
                // Primaries, ColorTransfer, MatrixCoeffs,
                // ColorRange, ColorStandard
