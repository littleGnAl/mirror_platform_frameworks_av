...
TEST_P(OpusHeaderWriteTest, WriteTest) {
    ...
    int32_t match = memcmp(reinterpret_cast<char *>(mInputBuffer),
                           reinterpret_cast<char *>(headerData), sizeof(headerData));
...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(make_tuple(1, 312, "OPUSoutput_channels_1skipSamples_312"),
                          make_tuple(2, 312, "OPUSoutput_channels_2skipSamples_312"),
                          make_tuple(5, 312, "OPUSoutput_channels_5skipSamples_312"),
                          make_tuple(6, 312, "OPUSoutput_channels_6skipSamples_312"),
                          make_tuple(1, 0, "OPUSoutput_channels_1skipSamples_0"),
                          make_tuple(2, 0, "OPUSoutput_channels_2skipSamples_0"),
                          make_tuple(5, 0, "OPUSoutput_channels_5skipSamples_0"),
                          make_tuple(6, 0, "OPUSoutput_channels_6skipSamples_0"),
                          make_tuple(1, 624, "OPUSoutput_channels_1skipSamples_624"),
                          make_tuple(2, 624, "OPUSoutput_channels_2skipSamples_624"),
                          make_tuple(5, 624, "OPUSoutput_channels_5skipSamples_624"),
                          make_tuple(6, 624, "OPUSoutput_channels_6skipSamples_624")));
