        ...
        for(compCtr=0; compCtr < numComp; compCtr++)
        {
            if(1 == fgcParams->compModelPresentFlag[compCtr])
            {
                ...
                for(y=0;y < height_forloop; y+=BLK_16)
                {
                    ...
                    for(x=0;x < width_forloop; x+=BLK_16)
                    {
                        ...
                        for(blkId=0;blkId < NUM_8x8_BLKS_16x16;blkId++)
                        {
                            ...
                            blockAvg = fgsFunc->block_avg_8x8_10bit(decSampleHbdBlk8, strideComp[compCtr], &numSamples,
                                    bitDepth);
                            ...
                            if(INTENSITY_INTERVAL_MATCH_FAIL != intensityInt)
                            {
                                ...
                                fgsFunc->simulate_grain_blk8x8_10bit(grainStripe,grainStripeOffsetBlk8,
                ...
                if((heightComp[compCtr] & 0xF))
                {
                    ...
                    fgsFunc->blend_stripe_10bit(decSampleHbdOffsetY, grainStripe,
                            strideComp[compCtr], grainStripeWidth, MIN(BLK_16, (heightComp[compCtr]-y)), bitDepth);
                ...
                for(y=0;y < height_forloop; y+=BLK_16)
                {
                    ...
                    for(x=0;x < width_forloop; x+=BLK_16)
                    {
...

                        {
                            ...
                            blockAvg = fgsFunc->block_avg_16x16_10bit(decSampleHbdBlk16, strideComp[compCtr], &numSamples,
                                    bitDepth);
                            ...
                            if(INTENSITY_INTERVAL_MATCH_FAIL != intensityInt)
                            {
                                ...
                                /* 8x8 block grain simulation */
                                fgsFunc->simulate_grain_blk16x16_10bit(grainStripe,grainStripeOffset,
                                        grainSynt, grainStripeWidth,
                                        log2ScaleFactor,scaleFactor,kOffset,lOffset,h,v);
                ...
                for(y=0;y < height_forloop; y+=BLK_16)
                {
                    ...
                    for(x=0;x < width_forloop; x+=BLK_16)
                    {
                        ...
                        for(blkId=0;blkId < NUM_8x8_BLKS_16x16;blkId++)
                        {
                            ...
                            blockAvg = fgsFunc->block_avg_8x8_8bit(decSampleBlk8, strideComp[compCtr], &numSamples,
                                    BLK_8_shift);
                            ...
                            if(INTENSITY_INTERVAL_MATCH_FAIL != intensityInt)
                            {
                                ...
                                /* 8x8 block grain simulation */
                                fgsFunc->simulate_grain_blk8x8_8bit(grainStripe,grainStripeOffsetBlk8,
                                        grainSynt, grainStripeWidth,
                                        log2ScaleFactor,scaleFactor,kOffset,lOffset,h,v);
...
uint32_t fgs_simulation_blending_8bit_16x16(fgsProcessArgs *inArgs)//GrainCharacteristicApi fgsParamStruct,void *psFgsHandle)
{
            ...
            if(1 == fgcParameters->compModelPresentFlag[compCtr])
            {
                ...
                for(y=0;y < height_forloop; y+=BLK_16)
                {
                    ...
                    for(x=0;x < width_forloop; x+=BLK_16)
                    {
                        ...
                        {
                            blockAvg = fgsFunc->block_avg_16x16_8bit(decSampleBlk16, strideComp[compCtr], &numSamples,
                                    BLK_16_shift);
        ...
        for(compCtr=0; compCtr < numComp; compCtr++)
        {
            ...
            if(1 == fgsParamStruct.fgcParameters.compModelPresentFlag[compCtr])
            {
                ...
                args->fgsArgs.decComp[compCtr] = (void *)(decComp[compCtr] +
                        offset_dec_bufs * z * numSripesPerThr[compCtr] * BLK_16 * strideComp[compCtr]);
