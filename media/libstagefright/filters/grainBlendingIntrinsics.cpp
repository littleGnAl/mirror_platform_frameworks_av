    ...
    if((widthComp & 0xF) == 0)
    {
        for(l=0; l < blockHeight; l++)
        {
            for(k=0; k< widthComp; k+=BLK_16)
            {
                ...
                __m128i __m128i_decData2 = _mm_cvtepu8_epi16(_mm_loadu_si128((__m128i *)
                                                                (decSampleOffsetY + BLK_8)));

                __m128i __m128i_grainSt1 = _mm_cvtepi8_epi16(__m128i_grainSt);
                __m128i __m128i_grainSt2 = _mm_cvtepi8_epi16(_mm_loadu_si128((__m128i *)
                                                                (grainStripe + BLK_8)));
        ...
        uint8_t h,uint8_t v)
{
    ...
    for(l = 0; l < BLK_16; l++)
    {
        ...
        __m128i __m128i_grainStripe_st1 = _mm_packs_epi32(__m128i_grainStripe1,
                                                            __m128i_grainStripe2);
        __m128i __m128i_grainStripe_st2 = _mm_packs_epi32(__m128i_grainStripe3,
                                                            __m128i_grainStripe4);
