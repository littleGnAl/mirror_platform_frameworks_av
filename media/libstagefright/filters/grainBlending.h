...
typedef struct fgsFxns
{
    ...
    uint32_t (*block_avg_8x8_8bit)(uint8_t *decSampleBlk8,
            uint32_t widthComp, uint16_t *pNumSamples, uint8_t shift_Size);
...
uint32_t block_avg_8x8_10bit_av8(uint16_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t bitDepth);

uint32_t block_avg_16x16_10bit_av8(uint16_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t bitDepth);

uint32_t block_avg_8x8_8bit_av8(uint8_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t shift_Size);

uint32_t block_avg_16x16_8bit_av8(uint8_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t shift_Size);

void simulate_grain_blk16x16_8bit_av8(int8_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);

void simulate_grain_blk8x8_8bit_av8(int8_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);

void simulate_grain_blk8x8_10bit_av8(int16_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);

void simulate_grain_blk16x16_10bit_av8(int16_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);
#endif
...
uint32_t block_avg_8x8_10bit_avx(uint16_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t bitDepth);

uint32_t block_avg_16x16_10bit_avx(uint16_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t bitDepth);

uint32_t block_avg_8x8_8bit_avx(uint8_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t shift_Size);

uint32_t block_avg_16x16_8bit_avx(uint8_t *decSampleBlk8,
        uint32_t widthComp,
        uint16_t *pNumSamples,
        uint8_t shift_Size);

void simulate_grain_blk16x16_8bit_avx(int8_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);

void simulate_grain_blk8x8_8bit_avx(int8_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);

void simulate_grain_blk8x8_10bit_avx(int16_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);

void simulate_grain_blk16x16_10bit_avx(int16_t *grainStripe, uint32_t grainStripeOffsetBlk8,
        GrainSynthesisStruct *grain_synt, uint32_t width, uint8_t log2ScaleFactor,
        int16_t scaleFactor, uint32_t kOffset, uint32_t lOffset,
        uint8_t h, uint8_t v);
#endif
