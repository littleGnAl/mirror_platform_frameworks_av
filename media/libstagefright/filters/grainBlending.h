...
struct fgsFxns {
  ...
  uint32_t (*block_avg_8x8)(T *decSampleBlk, uint32_t widthComp, uint8_t bitDepth, int16_t blkSz,
                            int16_t blkShift);

  uint32_t (*block_avg_16x16)(T *decSampleBlk, uint32_t widthComp, uint8_t bitDepth, int16_t blkSz,
                              int16_t blkShift);

  void (*simulate_grain_blk8x8)(int8_t *grainStripe, uint32_t grainStripeOffsetBlk,
  ...
  void (*simulate_grain_blk16x16)(int8_t *grainStripe, uint32_t grainStripeOffsetBlk,
                                  GrainSynthesisStruct *grain_synt, uint32_t width,
                                  uint8_t log2ScaleFactor, int16_t scaleFactor, uint32_t kOffset,
                                  uint32_t lOffset, uint8_t h, uint8_t v, uint32_t blkSz);
};
