    ...
    while (size >= 8) {
        ...
        switch(chunkType) {
            case FOURCC('t', 'x', '3', 'g'):
            {
                ...
                // This information is part of the 3gpp Sample Description format
                // Specification#: 26.245
                // https://portal.3gpp.org/desktopmodules/Specifications/SpecificationDetails.aspx?specificationId=1442
