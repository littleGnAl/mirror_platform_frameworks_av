...
static const char *kCodecHdrStaticInfoExistence = "android.media.mediacodec.hdr-static-info-existence";
    ...
    if (mIsVideo) {
        ...
        if (mMetricsHandle != 0) {
            ...
            if (format->findBuffer("hdr-static-info", &hdrStaticInfo)) {
                hdrStaticInfoExist = 1;
            } else {
                hdrStaticInfoExist = 0;
            }
            mediametrics_setInt32(mMetricsHandle, kCodecHdrStaticInfoExistence, hdrStaticInfoExist);
        }
