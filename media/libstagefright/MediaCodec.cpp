...
//
// RMDeathNotifier implements a Singleton class that:
//   - Manages binder interface to ResourceManagerService.
//   - Handles IResourceManagerService binder death event.
//
// The user of RMDeathNotifier (which is MediaCodec::ResourceManagerServiceProxy)
// calls RMDeathNotifier::getService() to communicate with ResourceManagerService
//
...
public:
    ...
    // returns binder interface to ResourceManagerService
