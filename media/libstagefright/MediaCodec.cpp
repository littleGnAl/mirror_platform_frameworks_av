...
static const char *kCodecConfigColorStandard = "android.media.mediacodec.configured-color-standard";
static const char *kCodecConfigColorRange = "android.media.mediacodec.configured-color-range";
static const char *kCodecConfigColorTransfer = "android.media.mediacodec.configured-color-transfer";
...
static const char *kCodecHDRMetadataExist = "android.media.mediacodec.hdr-metadata-exist";
...
void MediaCodec::updateMediametrics() {
    ...
    mediametrics_setInt32(mMetricsHandle, kCodecHDRMetadataExist, mHDRMetadataFlags);
#if 0
