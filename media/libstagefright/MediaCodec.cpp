            ...
            switch (what) {
                ...
                case kWhatComponentConfigured:
                {
                    ...
                    if (mMetricsHandle != 0) {
                        ...
                        int64_t configurationLatency = configurationEndNs - mMediaCodecConfigurationStartNs;
                        mediametrics_setInt64(mMetricsHandle, kCodecConfigurationLatency, configurationLatency);
                    }
                ...
                case kWhatStartCompleted:
                {
                    ...
                    if (mMetricsHandle != 0) {
                        ...
                        int64_t startingLatency = mMediaCodecStartingEndNs - mMediaCodecStartingStartNs;
                        mediametrics_setInt64(mMetricsHandle, kCodecStartingLatency, startingLatency);
                    }
                ...
                case kWhatDrainThisBuffer:
                {
                    if ((mFlags & kFlagUseBlockModel) == 0 && mTunneled) {
                        ...
                        if (mMetricsHandle != 0 && mIsInitialization) {
                            ...
                            int64_t firstBufferOutLatency = firstBufferOut - mMediaCodecStartingEndNs;
                            int64_t mediaCodecInitializationLatency = firstBufferOut - mMediaCodecCreationStartNs;
