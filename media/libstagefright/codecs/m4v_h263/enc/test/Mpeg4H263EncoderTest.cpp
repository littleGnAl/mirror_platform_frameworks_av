...
#define encodedFile "/data/local/tmp/Mpeg4H263Output"

constexpr int8_t kIDRFrameRefreshIntervalInSec = 1;
constexpr int32_t kOutputBufferSize = 250 * 1024;
...
class Mpeg4H263EncoderTest
  ...
  public:
    ...
    void SetUp() override {
        ...
        ASSERT_FALSE(mFrameWidth % 16 != 0 || mFrameHeight % 16 != 0 || mFrameHeight > 480 ||
                     mFrameWidth > 720)
                << "Height <= 480 && Width <= 720 and both should be multiple of 16";
