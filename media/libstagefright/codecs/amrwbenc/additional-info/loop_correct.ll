; ModuleID = 'loop_correct.bc'
target datalayout = "e-m:e-i64:64-i128:128-n32:64-S128"
target triple = "aarch64--linux-android"

; Function Attrs: norecurse nounwind sspstrong uwtable
define void @loop_correct(i16* nocapture %exc, i16* nocapture readonly %code, i16 %gain_code, i16 %gain_pit, i32 %i_subfr) #0 {
min.iters.checked:
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %28 = icmp sgt <8 x i32> %27, <i32 1073741823, i32 1073741823, i32 1073741823, i32 1073741823, i32 1073741823, i32 1073741823, i32 1073741823, i32 1073741823>
  %29 = icmp slt <8 x i32> %27, <i32 -1073741824, i32 -1073741824, i32 -1073741824, i32 -1073741824, i32 -1073741824, i32 -1073741824, i32 -1073741824, i32 -1073741824>
  %30 = shl <8 x i32> %27, <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
  %31 = select <8 x i1> %29, <8 x i32> <i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648, i32 -2147483648>, <8 x i32> %30
  %predphi = select <8 x i1> %28, <8 x i32> <i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647, i32 2147483647>, <8 x i32> %31
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %L_shl2.exit
  %indvars.iv = phi i64 [ %indvars.iv.next, %L_shl2.exit ], [ 0, %scalar.ph.preheader ]
...
; <label>:65                                      ; preds = %scalar.ph
  %66 = icmp slt i32 %L_var_out.0.i3, -1073741824
  %67 = shl i32 %L_var_out.0.i3, 1
  %..i = select i1 %66, i32 -2147483648, i32 %67
  br label %L_shl2.exit

L_shl2.exit:                                      ; preds = %scalar.ph, %65
  %68 = phi i32 [ %..i, %65 ], [ 2147483647, %scalar.ph ]
  ...
  %73 = lshr i32 %68, 31
  %74 = add nuw i32 %73, 2147483647
  %L_var_out.0.i1 = select i1 %or.cond.i, i32 %74, i32 %69
  %75 = lshr i32 %L_var_out.0.i1, 16
  %76 = trunc i32 %75 to i16
  store i16 %76, i16* %50, align 2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp eq i64 %indvars.iv.next, 64
  br i1 %exitcond, label %middle.block.loopexit, label %scalar.ph, !llvm.loop !5
