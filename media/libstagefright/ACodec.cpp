                ...
                case OMX_AUDIO_CodingPCM:
                {
                    ...
                    if (!mIsEncoder && portIndex == kPortIndexOutput) {
                        ...
                        if (mConfigFormat->findString("mime", &mime)
                            ...
                            notify->setInt32(
                                    "aac-encoded-target-level",presentation.nEncodedTargetLevel);
                            notify->setInt32("aac-drc-cut-level", presentation.nDrcCut);
                            notify->setInt32("aac-drc-boost-level", presentation.nDrcBoost);
                            notify->setInt32(
                                    "aac-drc-heavy-compression", presentation.nHeavyCompression);
                            notify->setInt32(
                                    "aac-target-ref-level", presentation.nTargetReferenceLevel);
                            ...
                            notify->setInt32(
                                    "aac-drc-output-loudness", presentation.nDrcOutputLoudness);
                        }
                    }
                    break;
                }
