...
const char *MEDIA_MIMETYPE_AUDIO_DTSHD_PROFILE_MA = "audio/vnd.dts.hd;profile=dtsma";
const char *MEDIA_MIMETYPE_AUDIO_DTSHD_PROFILE_LBR = "audio/vnd.dts.hd;profile=lbr";
const char *MEDIA_MIMETYPE_AUDIO_DTS_UHD = "audio/vnd.dts.uhd";
const char *MEDIA_MIMETYPE_AUDIO_DTSUHD_PROFILE_P2 = "audio/vnd.dts.uhd;profile=p2"; 
