...
static status_t parseAC4SyncFrame(
    ...
    LOG_ALWAYS_FATAL_IF(!singlePresentation && numPresentations == 1, "Expect !=1 presentations");
    ...
    if (metaData != NULL) {
        ...
        if (!addEmdfSubstreams) {
            ...
            snprintf(codecsString, kMaxCodecsStringLength, "ac-4.%02u.%02u.%02u",
