...
class EffectConversionHelperAidl {
  ...
  private:
    ...
    typedef status_t (EffectConversionHelperAidl::*SetParameter)(
            const android::effect::utils::EffectParamWrapper& param);
    typedef status_t (EffectConversionHelperAidl::*GetParameter)(
            android::effect::utils::EffectParamWrapper& param);
    ...
    status_t setAecParameter(const android::effect::utils::EffectParamWrapper& param);
    status_t getAecParameter(android::effect::utils::EffectParamWrapper& param);
    status_t setAgcParameter(const android::effect::utils::EffectParamWrapper& param);
    status_t getAgcParameter(android::effect::utils::EffectParamWrapper& param);
    status_t setBassBoostParameter(const android::effect::utils::EffectParamWrapper& param);
    status_t getBassBoostParameter(android::effect::utils::EffectParamWrapper& param);
    status_t setDownmixParameter(const android::effect::utils::EffectParamWrapper& param);
    status_t getDownmixParameter(android::effect::utils::EffectParamWrapper& param);
};
