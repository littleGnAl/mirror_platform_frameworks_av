...
class AidlConversionEqualizer : public EffectConversionHelperAidl {
  public:
    AidlConversionEqualizer(std::shared_ptr<::aidl::android::hardware::audio::effect::IEffect> effect,
                      int32_t sessionId, int32_t ioId,
                      const ::aidl::android::hardware::audio::effect::Descriptor& desc)
        : EffectConversionHelperAidl(effect, sessionId, ioId, desc) {}
    ~AidlConversionEqualizer() {}
