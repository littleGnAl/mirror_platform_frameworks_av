...
status_t AidlConversionDynamicsProcessing::getChannelConfig(DynamicsProcessing::Tag tag,
...
status_t AidlConversionDynamicsProcessing::getEqBandConfig(DynamicsProcessing::Tag tag,
                                                           EffectParamWriter& param) {
