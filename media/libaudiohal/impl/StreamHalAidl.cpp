...
status_t StreamOutHalAidl::write(const void *buffer __unused, size_t bytes __unused, size_t *written __unused) {
...
status_t StreamOutHalAidl::supportsPauseAndResume(bool *supportsPause __unused, bool *supportsResume __unused) {
    TIME_CHECK();
    if (!mStream) return NO_INIT;
    ALOGE("%s not implemented yet", __func__);
    return OK;
...
status_t StreamOutHalAidl::getPresentationPosition(uint64_t *frames __unused, struct timespec *timestamp __unused) {
    // TIME_CHECK();  // TODO(b/238654698) reenable only when optimized.
    if (!mStream) return NO_INIT;
    ALOGE("%s not implemented yet", __func__);
    return OK;
...
status_t StreamInHalAidl::read(void *buffer __unused, size_t bytes __unused, size_t *read __unused) {
    // TIME_CHECK();  // TODO(b/238654698) reenable only when optimized.
    if (!mStream) return NO_INIT;
    ALOGE("%s not implemented yet", __func__);
