...
status_t DeviceHalAidl::openOutputStream(audio_io_handle_t handle __unused, audio_devices_t devices __unused,
...
status_t DeviceHalAidl::openInputStream(audio_io_handle_t handle __unused, audio_devices_t devices __unused,
...
status_t DeviceHalAidl::addDeviceEffect(audio_port_handle_t device __unused, sp<EffectHalInterface> effect) {
    if (!effect) {
        return BAD_VALUE;
    }
    TIME_CHECK();
