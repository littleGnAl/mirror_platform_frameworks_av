...
class DeviceHalAidl : public DeviceHalInterface, public ConversionHelperAidl {
  ...
  private:
    ...
    using Patches = std::map<int32_t, ::aidl::android::hardware::audio::core::AudioPatch>;
    using PortConfigs = std::map<int32_t, ::aidl::android::media::audio::common::AudioPortConfig>;
    ...
    Patches mPatches;
    std::map<audio_patch_handle_t, int32_t> mFwkHandleToPatchId;
};
