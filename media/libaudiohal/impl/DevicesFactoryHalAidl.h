...
{
  public:
    explicit DevicesFactoryHalAidl(std::shared_ptr<::aidl::android::hardware::audio::core::IConfig> iConfig);
  ...
  private:
    std::shared_ptr<::aidl::android::hardware::audio::core::IConfig> mIConfig;
