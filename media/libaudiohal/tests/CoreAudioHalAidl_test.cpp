...
class DeviceHalAidlTest : public testing::Test {
  ...
  protected:
    String8 createParameterString(const char* key, const char* value) {
        AudioParameter params;
        params.add(String8(key), String8(value));
        return params.toString();
    }
    String8 createParameterString(const char* key, int value) {
        AudioParameter params;
        params.addInt(String8(key), value);
        return params.toString();
    }
