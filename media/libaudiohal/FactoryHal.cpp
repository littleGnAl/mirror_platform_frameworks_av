...
void *createPreferredImpl(bool isDevice) {
    ...
    auto faceMap = isDevice ? sDevicesHALInterfaces : sEffectsHALInterfaces;
    auto siblingfaceMap = isDevice ? sEffectsHALInterfaces : sDevicesHALInterfaces;
    auto ifaceVersionIt = findMostRecentVersion(faceMap);
    auto siblingVersionIt = findMostRecentVersion(siblingfaceMap);
