  ...
  public:
    StressTestEnvironment()
        : res("/data/local/tmp/MediaStress/res/"),
          statsFile("/data/local/tmp/MediaStress/res/stats.csv") {}
...
int StressTestEnvironment::initFromOptions(int argc, char **argv) {
 ...
 **/
bool StressTestEnvironment::writeStatsHeader() {
    char statsHeader[] =
