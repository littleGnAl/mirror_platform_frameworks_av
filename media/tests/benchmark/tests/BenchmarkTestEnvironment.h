...
class BenchmarkTestEnvironment : public ::testing::Environment {
  public:
    BenchmarkTestEnvironment() : res("/data/local/tmp/MediaBenchmark/res/"),
                                 statsFile("/data/local/tmp/MediaBenchmark/res/") {}
 ...
 **/
bool BenchmarkTestEnvironment::writeStatsHeader(string statsFile) {
    char statsHeader[] =
