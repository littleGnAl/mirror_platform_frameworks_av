...
${OUT}/target/product/blueline/testcases/MediaBenchmarkApp/arm64/

## For installing the apk, run the command:
```
adb install -f -r ${OUT}/target/product/blueline/testcases/MediaBenchmarkApp/arm64/MediaBenchmarkApp.apk
```
