...
public class ExtractorTest {
    ...
    private static final String mInputFilePath = mContext.getString(R.string.inputFilePath);
    ...
    public static Collection<Object[]> inputFiles() {
        return Arrays.asList(new Object[][]{
                /* Parameters: filename, trackId*/
                {"bbb_44100hz_2ch_128kbps_aac_30sec.mp4", 0},
                {"bbb_44100hz_2ch_128kbps_aac_5mins.mp4", 0},
                {"bbb_44100hz_2ch_128kbps_mp3_30sec.mp3", 0},
                {"bbb_44100hz_2ch_128kbps_mp3_5mins.mp3", 0},
                {"bbb_44100hz_2ch_80kbps_vorbis_30sec.mp4", 0},
                {"bbb_44100hz_2ch_80kbps_vorbis_5mins.mp4", 0},
                {"bbb_48000hz_2ch_100kbps_opus_30sec.webm", 0},
                ...
                {"crowd_1920x1080_25fps_4000kbps_vp9.webm", 0},
                {"crowd_1920x1080_25fps_6000kbps_mpeg4.mp4", 0},
                {"crowd_1920x1080_25fps_7300kbps_mpeg2.mp4", 0},
                {"crowd_352x288_25fps_6000kbps_h263.3gp", 0},
                {"bbb_16000hz_1ch_9kbps_amrwb_30sec.3gp", 0},
                {"bbb_16000hz_1ch_9kbps_amrwb_5mins.3gp", 0},
                {"bbb_44100hz_1ch_64kbps_alaw_30sec.wav", 0},
                {"bbb_44100hz_1ch_64kbps_alaw_5mins.wav", 0},
                {"bbb_44100hz_1ch_64kbps_mulaw_30sec.wav", 0},
                {"bbb_44100hz_1ch_64kbps_mulaw_5mins.wav", 0},
                {"bbb_44100hz_2ch_600kbps_flac_5mins.flac", 0},
                {"bbb_8000hz_1ch_8kbps_amrnb_30sec.3gp", 0},
    ...
    public ExtractorTest(String filename, int track) {
        this.mInputFileName = mInputFilePath + filename;
        this.mTrackId = track;
    }
    ...
    public void sampleExtractTest() throws IOException {
        ...
        if (inputFile.exists()) {
            ...
            Log.i(TAG, "Test files not found.");
        }
