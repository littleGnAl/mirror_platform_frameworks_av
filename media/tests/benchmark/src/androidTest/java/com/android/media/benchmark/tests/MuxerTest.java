        ...
        if (inputFile.exists()) {
            ...
            for (int currentTrack = 0; currentTrack < trackCount; currentTrack++) {
                ...
                while (true) {
                    ...
                    inputBuffer.add(extractor.getFrameBuffer());
                    if (sampleSize < 0) {
                        break;
                    }
                }
                ...
                if (outputFormat != -1) {
                    ...
                    muxer.mux(trackIndex, inputBuffer, inputBufferInfo);
                    muxer.deInitMuxer();
                    ...
                    Log.i(TAG, "Invalid format");
                }
            }
            extractor.deinitExtractor();
            fileInput.close();
        } else {
            Log.i(TAG, "Unable to open input file for reading");
        }
    }
}
