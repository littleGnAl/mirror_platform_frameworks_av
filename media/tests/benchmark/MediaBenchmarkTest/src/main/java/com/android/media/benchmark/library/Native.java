...
public class Native {
    ...
    public native void Decode(
            String inputFilePath, String inputFileName, String codecName, boolean asyncMode);

    public native void Encode(String inputFilePath, String inputFileName, String outputFilePath,
            String codecName);
}
