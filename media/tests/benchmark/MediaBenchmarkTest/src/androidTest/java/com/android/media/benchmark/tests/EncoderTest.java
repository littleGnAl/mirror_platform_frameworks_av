...
public class EncoderTest {
    ...
    public void sampleEncoderTest() throws Exception {
        ...
        if (inputFile.exists()) {
            ...
            if (trackCount <= 0) {
                Log.e(TAG, "Warning. Extraction failed. No tracks for file: " + mInputFile);
                return;
            }
            ...
            for (int currentTrack = 0; currentTrack < trackCount; currentTrack++) {
                ...
                File decodedFile = new File(mContext.getFilesDir() + "/decoder.out");
                ...
                for (Boolean asyncMode : encodeMode) {
                    for (String codecName : mediaCodecs) {
                        ...
                        File rawFile = new File(mContext.getFilesDir() + "/decoder.out");
                        if (rawFile.exists()) {
                            if (DEBUG) {
                            ...
                            if (status == 0) {
                                ...
                                Log.i(TAG, "Encoding Successful for file: " + mInputFile +
