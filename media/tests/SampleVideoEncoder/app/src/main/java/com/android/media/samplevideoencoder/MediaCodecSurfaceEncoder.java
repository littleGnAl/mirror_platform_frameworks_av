...
public class MediaCodecSurfaceEncoder {
    ...
    void startEncodingSurface() throws IOException, InterruptedException {
        ...
        if (listOfDeocders.isEmpty()) {
            Toast.makeText(mActivityContext, "No suitable decoder found for mime: " + decoderMime,
                    Toast.LENGTH_SHORT);
        ...
        if (listOfEncoders.isEmpty()) {
            Toast.makeText(mActivityContext, "No suitable encoder found for mime: " + mMime,
                    Toast.LENGTH_SHORT);
    ...
    private void configureCodec(MediaFormat decFormat, MediaFormat encFormat) {
        ...
        if (!mSurface.isValid()) {
            Toast.makeText(mActivityContext, "Invalid Surface", Toast.LENGTH_SHORT);
