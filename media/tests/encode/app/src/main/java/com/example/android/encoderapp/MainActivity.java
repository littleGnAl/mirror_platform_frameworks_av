...
public class MainActivity extends AppCompatActivity
    ...
    private static final String TAG = "EncoderApp";
    ...
    private boolean mIsEncoderTypeSoftware = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioGroup radioGroup1 = findViewById(R.id.radio_group_mime);
        ...
        RadioGroup radioGroup2 = findViewById(R.id.radio_group_codec);
        radioGroup2.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                mIsEncoderTypeSoftware = checkedId == R.id.sw;
            }
        });
    ...
    private static class MediaCodecSurfaceAsync extends AsyncTask<String, String, Bitmap> {
        ...
        protected Bitmap doInBackground(String... strings) {
            ...
            MediaCodecSurfaceEncoder codecSurfaceEncoder =
                    new MediaCodecSurfaceEncoder(mainActivity.getApplicationContext(), resId,
                            mainActivity.mMime, mainActivity.mIsEncoderTypeSoftware,
                            mainActivity.mOutputVideoPath);
            try {
                codecSurfaceEncoder.startEncodingSurface();
