...
static const struct InputData {
    ...
    int32_t frameRate;
        ...
        {MEDIA_MIMETYPE_AUDIO_AAC, "test_mono_44100Hz_aac.aac", 44100, 1, AACObjectLC, -1},
        {MEDIA_MIMETYPE_AUDIO_AMR_NB, "bbb_mono_8kHz_amrnb.amr", 8000, 1, -1, -1},
        {MEDIA_MIMETYPE_AUDIO_AMR_WB, "bbb_mono_16kHz_amrwb.amr", 16000, 1, -1, -1},
        {MEDIA_MIMETYPE_AUDIO_VORBIS, "bbb_stereo_48kHz_vorbis.ogg", 48000, 2, -1, -1},
        {MEDIA_MIMETYPE_AUDIO_MSGSM, "test_mono_8kHz_gsm.wav", 8000, 1, -1, -1},
        {MEDIA_MIMETYPE_VIDEO_MPEG2, "bbb_cif_768kbps_30fps_mpeg2.ts", 352, 288, MPEG2ProfileMain,
         -1},
        {MEDIA_MIMETYPE_AUDIO_RAW, "bbb_stereo_48kHz_flac.flac", 48000, 2, -1, -1},
        {MEDIA_MIMETYPE_AUDIO_OPUS, "test_stereo_48kHz_opus.opus", 48000, 2, -1, -1},
        {MEDIA_MIMETYPE_AUDIO_RAW, "midi_a.mid", 22050, 2, -1, -1},
        {MEDIA_MIMETYPE_VIDEO_MPEG4, "bbb_cif_768kbps_30fps_mpeg4.mkv", 352, 288,
         MPEG4ProfileSimple, -1},
        // Test (b/151677264) for MP4 extractor
        {MEDIA_MIMETYPE_VIDEO_AVC, "test_1920x1080_10fps_avc.mp4", 1920, 1080, AVCProfileMain, 10},
        {MEDIA_MIMETYPE_AUDIO_MPEG, "bbb_stereo_48kHz_mp3.mp3", 48000, 2, -1, -1},
        {MEDIA_MIMETYPE_VIDEO_VP9, "bbb_340x280_30fps_vp9.webm", 340, 280, VP9Profile0, -1},
        {MEDIA_MIMETYPE_VIDEO_MPEG2, "swirl_144x136_mpeg2.mpg", 144, 136, MPEG2ProfileMain, -1},
};
...
void ConfigParamTest::getFileProperties(int32_t inputIdx, string &inputFile,
    ...
    strcpy(configParam.mime, kInputData[inputIdx].mime);
    if (!strncmp(configParam.mime, "audio/", 6)) {
...
TEST_P(ConfigParamTest, ConfigParamValidation) {
    ...
    ASSERT_STREQ(configParam.mime, trackMime) << "Invalid track format";
    ...
    if (!strncmp(trackMime, "audio/", 6)) {
        ...
        if (mExtractorName == standardExtractors::MPEG4) {
            int32_t frameRate;
            ASSERT_TRUE(
...
INSTANTIATE_TEST_SUITE_P(ConfigParamTestAll, ConfigParamTest,
                         ::testing::Values(make_pair("aac", 0), make_pair("amr", 1),
                                           make_pair("amr", 2), make_pair("ogg", 3),
                                           make_pair("wav", 4), make_pair("mpeg2ts", 5),
                                           make_pair("flac", 6), make_pair("ogg", 7),
                                           make_pair("midi", 8), make_pair("mkv", 9),
                                           make_pair("mpeg4", 10), make_pair("mp3", 11),
                                           make_pair("mkv", 12), make_pair("mpeg2ps", 13)));
