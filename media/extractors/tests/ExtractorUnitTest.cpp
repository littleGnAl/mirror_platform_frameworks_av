...
class ExtractorComparision : public ExtractorUnitTest,
                             public ::testing::TestWithParam<
                                     pair<pair<string /* container1 */, string /* InputFile1 */>,
                                          pair<string /* container2 */, string /* InputFile2 */>>> {
  public:
    ExtractorComparision() : mExtractedOutput1(nullptr), mExtractedOutput2(nullptr) {}

    ~ExtractorComparision() {
...
TEST_P(ExtractorComparision, ExtractorComparisionTest) {
    pair<string, string> extractor1 = GetParam().first;
    pair<string, string> extractor2 = GetParam().second;
...
INSTANTIATE_TEST_SUITE_P(
        ExtractorComparisionAll, ExtractorComparision,
