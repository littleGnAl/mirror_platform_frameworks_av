...
INSTANTIATE_TEST_SUITE_P(ExtractorUnitTestAll, ExtractorFunctionalityTest,
                         ::testing::Values(make_tuple("aac", "loudsoftaac.aac", true),
                                           ...
                                           make_tuple("mkv", "sinesweepmp3lame.mkv", true),
                                           make_tuple("mkv", "loudsoftaac.mkv", true),
                                           make_tuple("mp3", "sinesweepmp3lame.mp3", true),
                                           make_tuple("mp3", "id3test10.mp3", true),
                                           make_tuple("mpeg2ts", "segment000001.ts", false),
                                           make_tuple("mpeg2ts", "testac3ts.ts", false),
                                           make_tuple("mpeg2ts", "testac4ts.ts", false),
                                           make_tuple("mpeg2ts", "testeac3ts.ts", false),
                                           make_tuple("mpeg4", "sinesweepoggmp4.mp4", true),
                                           make_tuple("mpeg4", "testac3mp4.mp4", true),
                                           make_tuple("mpeg4", "testeac3mp4.mp4", true),
                                           make_tuple("ogg", "john_cage.ogg", true),
                                           make_tuple("ogg", "testopus.opus", true),
                                           make_tuple("ogg", "sinesweepoggalbumart.ogg", true),
                                           make_tuple("wav", "monotestgsm.wav", true),

                                           make_tuple("mkv", "swirl_144x136_avc.mkv", true),
                                           make_tuple("mkv", "withoutcues.mkv", true),
                                           ...
                                           make_tuple("mpeg2ps", "programstream.mpeg", false),
