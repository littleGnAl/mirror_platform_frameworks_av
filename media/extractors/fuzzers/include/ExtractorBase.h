...
#ifndef __EXTRACTOR_BASE_H__
#define __EXTRACTOR_BASE_H__
...
class ExtractorBase {
 public:
  ...
  virtual bool setDataSource(const uint8_t* data, size_t size);

  virtual bool createExtractor() = 0;

  virtual bool getExtractorDef();

  virtual bool extractTracks();

  virtual bool getMetadata();

  virtual bool getTracksMetadata();

  virtual void setDataSourceFlags(uint32_t flags);
