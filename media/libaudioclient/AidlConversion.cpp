...
const detail::AudioFormatPairs& getAudioFormatPairs() {
    static const detail::AudioFormatPairs pairs = {{
        ...
        {
            // Note: not in the IANA registry.
            AUDIO_FORMAT_APTX_ADAPTIVE_QLEA, make_AudioFormatDescription("audio/vnd.qcom.aptx.r3")
        },
        {
            // Note: not in the IANA registry.
            AUDIO_FORMAT_APTX_ADAPTIVE_R4, make_AudioFormatDescription("audio/vnd.qcom.aptx.r4")
        },
    }};
    return pairs;
}
