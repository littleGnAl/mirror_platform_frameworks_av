...
using aidl::android::hardware::audio::effect::DynamicsProcessingImplUUID;
...
extern "C" binder_exception_t createEffect(const AudioUuid* in_impl_uuid,
    ...
    if (!in_impl_uuid || *in_impl_uuid != DynamicsProcessingImplUUID()) {
...
const Descriptor DynamicsProcessingImpl::kDescriptor = {
        .common = {.id = {.type = DynamicsProcessingTypeUUID(),
                          .uuid = DynamicsProcessingImplUUID(),
                          .proxy = std::nullopt},
