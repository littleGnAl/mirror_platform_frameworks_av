...
static constexpr audio_channel_mask_t kChMasks[] = {
        ...
        AUDIO_CHANNEL_OUT_2POINT1POINT2, AUDIO_CHANNEL_OUT_3POINT0POINT2,
        AUDIO_CHANNEL_OUT_5POINT1,       AUDIO_CHANNEL_OUT_6POINT1,
        AUDIO_CHANNEL_OUT_5POINT1POINT2, AUDIO_CHANNEL_INDEX_MASK_16,
        AUDIO_CHANNEL_INDEX_MASK_24,
};

static constexpr size_t kNumChMasks = std::size(kChMasks);

static constexpr size_t kSampleRates[] = {8000,  11025, 22050,  44100, 48000, 192000};
