...
int Reverb_init(ReverbContext *pContext) {
  ...
  ALOGV("\tCreateInstance Successfully called LVREV_GetMemoryTable\n");
   ...
   * that were
   * successfully allocated and return with an error
   */
  ...
  ALOGV(
      "\tReverb_init CreateInstance Successfully called "
