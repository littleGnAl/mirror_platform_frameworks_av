...
constexpr float kAudioDurationPrimePadSec = 0.25;
...
TEST(TestEffect, AndroidEqualizerEffect) {
    ...
    const int frameCountPrimePad = kSamplingFrequency * kAudioDurationPrimePadSec;
    ASSERT_GE(kAudioDurationSec, 2 * kAudioDurationPrimePadSec + 1);
