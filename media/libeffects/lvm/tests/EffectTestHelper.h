...
#ifndef __EFFECT_TEST_HELPER_H__
#define __EFFECT_TEST_HELPER_H__
...
class EffectTestHelper {
  public:
    EffectTestHelper(const effect_uuid_t* uuid, size_t inChMask, size_t outChMask, size_t sampleRate, size_t frameCount,
                     size_t loopCount)
        : mUuid(uuid),
          mInChMask(inChMask),
...
#endif  // __EFFECT_TEST_HELPER_H__
