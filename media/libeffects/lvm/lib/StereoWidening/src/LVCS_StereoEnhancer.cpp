...
LVCS_ReturnStatus_en LVCS_SEnhancerInit(LVCS_Handle_t hInstance, LVCS_Params_t* pParams) {
    ...
    if ((pInstance->Params.SampleRate != pParams->SampleRate) ||
        ...
        pInstance->pSEMidBiquad.reset(new android::audio_utils::BiquadFilter<LVM_FLOAT>(1, coefs));
#else
        ...
        pInstance->pSESideBiquad.reset(new android::audio_utils::BiquadFilter<LVM_FLOAT>(1, coefs));
#else
        /* Convert incoming coefficients to the required format/ordering */
