...
LVREV_ReturnStatus_en LVREV_GetInstanceHandle(LVREV_Handle_t* phInstance,
    ...
    if (pInstanceParams->NumDelays == LVREV_DELAYLINES_4) {
        pLVREV_Private->pDelay_T[3] =
                (LVM_FLOAT*)InstAlloc_AddMember(&FastData, MaxT_Delay[3] * sizeof(LVM_FLOAT));
        pLVREV_Private->pDelay_T[2] =
                (LVM_FLOAT*)InstAlloc_AddMember(&FastData, MaxT_Delay[2] * sizeof(LVM_FLOAT));
        pLVREV_Private->pDelay_T[1] =
                (LVM_FLOAT*)InstAlloc_AddMember(&FastData, MaxT_Delay[1] * sizeof(LVM_FLOAT));
        pLVREV_Private->pDelay_T[0] =
                (LVM_FLOAT*)InstAlloc_AddMember(&FastData, MaxT_Delay[0] * sizeof(LVM_FLOAT));
    ...
    pLVREV_Private->T[0] = MaxT_Delay[0];
    pLVREV_Private->T[1] = MaxT_Delay[1];
    pLVREV_Private->T[2] = MaxT_Delay[2];
    pLVREV_Private->T[3] = MaxT_Delay[3];
    ...
    /* Delay tap index */
    pLVREV_Private->A_DelaySize[0] = MaxAP_Delay[0];
    pLVREV_Private->B_DelaySize[0] = MaxAP_Delay[0];
    pLVREV_Private->A_DelaySize[1] = MaxAP_Delay[1];
    pLVREV_Private->B_DelaySize[1] = MaxAP_Delay[1];
    pLVREV_Private->A_DelaySize[2] = MaxAP_Delay[2];
    pLVREV_Private->B_DelaySize[2] = MaxAP_Delay[2];
    pLVREV_Private->A_DelaySize[3] = MaxAP_Delay[3];
    pLVREV_Private->B_DelaySize[3] = MaxAP_Delay[3];
