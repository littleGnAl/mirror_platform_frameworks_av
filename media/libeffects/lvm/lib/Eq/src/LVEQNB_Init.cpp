                                   ...
                                   void                     *pScratch)
{
    ...
    *phInstance = calloc(1, sizeof(*pInstance));
    ...
    pInstance->pEQNB_FilterState_Float = (Biquad_FLOAT_Instance_t *)malloc(MemSize);
    ...
    pInstance->pEQNB_Taps_Float = (Biquad_2I_Order2_FLOAT_Taps_t *)malloc(MemSize);
    ...
    pInstance->pBandDefinitions  = (LVEQNB_BandDef_t *)malloc(MemSize);
    ...
    pInstance->pBiquadType = (LVEQNB_BiquadType_en *)malloc(MemSize);
