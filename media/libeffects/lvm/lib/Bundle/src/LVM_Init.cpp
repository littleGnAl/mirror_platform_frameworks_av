...
LVM_ReturnStatus_en LVM_GetInstanceHandle(LVM_Handle_t *phInstance, LVM_InstParams_t *pInstParams) {
    ...
    *phInstance = (LVM_Handle_t)calloc(1, sizeof(*pInstance));
     ...
     */
    InternalBlockSize =
        (LVM_UINT16)((pInstParams->MaxBlockSize) &
    ...
    BundleScratchSize = (LVM_INT32)(
        3 * LVM_MAX_CHANNELS * (MIN_INTERNAL_BLOCKSIZE + InternalBlockSize) * sizeof(LVM_FLOAT));
     ...
     */
    {
        ...
        EQNB_Capabilities.SampleRate =
            LVEQNB_CAP_FS_8000 | LVEQNB_CAP_FS_11025 | LVEQNB_CAP_FS_12000 | LVEQNB_CAP_FS_16000 |
            LVEQNB_CAP_FS_22050 | LVEQNB_CAP_FS_24000 | LVEQNB_CAP_FS_32000 | LVEQNB_CAP_FS_44100 |
            LVEQNB_CAP_FS_48000 | LVEQNB_CAP_FS_88200 | LVEQNB_CAP_FS_96000 | LVEQNB_CAP_FS_176400 |
