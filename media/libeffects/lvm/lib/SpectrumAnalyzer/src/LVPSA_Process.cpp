        ...
        switch (pLVPSA_Inst->pBPFiltersPrecision[ii]) {
...
#endif
                dumpData(FILEPATH(specBiquadSinglePrec.raw), pScratch + InputBlockSize,
                         InputBlockSize * sizeof(LVM_FLOAT));
                break;
            ...
            case LVPSA_DoublePrecisionFilter:
                ...
                BP_1I_D16F32C30_TRC_WRA_01(&pLVPSA_Inst->pBP_Instances[ii], pScratch,
                                           pScratch + InputBlockSize, (LVM_INT16)InputBlockSize);
#endif
                dumpData(FILEPATH(specBiquadDoublePrec.raw), pScratch + InputBlockSize,
                         InputBlockSize * sizeof(LVM_FLOAT));
                break;
            default:
                break;
