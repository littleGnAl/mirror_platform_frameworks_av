...
//
//----------------------------------------------------------------------------
int32_t EqualizerGetPreset(EffectContext *pContext) { return pContext->pBundledContext->CurPreset; }
...
int32_t EqualizerGetNumPresets() { return sizeof(gEqualizerPresets) / sizeof(PresetConfig); }
...
int Volume_setParameter(EffectContext *pContext, uint32_t paramSize, void *pParam,
    ...
    switch (params[0]) {
        ...
        case VOLUME_PARAM_ENABLESTEREOPOSITION: {
            ...
            status =
                VolumeEnableStereoPosition(pContext, positionEnabled)
    ...
    switch (cmdCode) {
        ...
        case EFFECT_CMD_SET_CONFIG:
            ...
            if (pCmdData == NULL || cmdSize != sizeof(effect_config_t) || pReplyData == NULL ||
                ...
                ALOGV(
                    "\tLVM_ERROR : Effect_command cmdCode Case: "
        ...
        case EFFECT_CMD_SET_PARAM: {
            ...
            if (pContext->EffectType == LVM_BASS_BOOST) {
                ...
                if (pCmdData == NULL ||
                    ...
                    ALOGV(
                        "\tLVM_ERROR : BassBoost_command cmdCode Case: "
            ...
            if (pContext->EffectType == LVM_VIRTUALIZER) {
                ...
                if (pCmdData == NULL ||
                    ...
                    pReplyData == NULL || replySize == NULL || *replySize != sizeof(int32_t)) {
                    ALOGV(
                        "\tLVM_ERROR : Virtualizer_command cmdCode Case: "
                        "EFFECT_CMD_SET_PARAM: ERROR");
                    return -EINVAL;
                }
            ...
            if (pContext->EffectType == LVM_EQUALIZER) {
                ...
                if (pCmdData == NULL || cmdSize < (sizeof(effect_param_t) + sizeof(int32_t)) ||
                    pReplyData == NULL || replySize == NULL || *replySize != sizeof(int32_t)) {
                    ALOGV(
                        "\tLVM_ERROR : Equalizer_command cmdCode Case: "
                        "EFFECT_CMD_SET_PARAM: ERROR");
                    return -EINVAL;
                }
            ...
            if (pContext->EffectType == LVM_VOLUME) {
                ...
                if (pCmdData == NULL || cmdSize < (sizeof(effect_param_t) + sizeof(int32_t)) ||
                    pReplyData == NULL || replySize == NULL || *replySize != sizeof(int32_t)) {
                    ALOGV(
                        "\tLVM_ERROR : Volume_command cmdCode Case: "
                        "EFFECT_CMD_SET_PARAM: ERROR");
                    return -EINVAL;
                }
