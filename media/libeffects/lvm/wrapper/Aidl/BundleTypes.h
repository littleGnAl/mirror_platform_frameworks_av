...
static constexpr size_t MAX_NUM_PRESETS = 10;
static constexpr size_t MAX_NUM_BANDS = 5;
static constexpr size_t MAX_CALL_SIZE = 256;
static constexpr int BASS_BOOST_CUP_LOAD_ARM9E = 150;   // Expressed in 0.1 MIPS
static constexpr int VIRTUALIZER_CUP_LOAD_ARM9E = 120;  // Expressed in 0.1 MIPS
static constexpr int EQUALIZER_CUP_LOAD_ARM9E = 220;    // Expressed in 0.1 MIPS
static constexpr int VOLUME_CUP_LOAD_ARM9E = 0;         // Expressed in 0.1 MIPS
static constexpr int BUNDLE_MEM_USAGE = 25;             // Expressed in kB
static constexpr int PRESET_CUSTOM = -1;
...
*/
static constexpr std::array<uint16_t, MAX_NUM_BANDS> kPresetsFrequencies = {60, 230, 910, 3600,
                                                                            14000};

/* Q factor multiplied by 100 */
static constexpr std::array<uint16_t, MAX_NUM_BANDS> kPresetsQFactors = {96, 96, 96, 96, 96};

static const std::array<std::array<int16_t, MAX_NUM_BANDS>, MAX_NUM_PRESETS> kSoftPresets = {{
 ...
 * updated.
 */
static constexpr std::array<float, MAX_NUM_BANDS> kBandEnergyCoefficient = {7.56, 9.69, 9.59, 7.37,
                                                                            2.88};

static constexpr std::array<float, MAX_NUM_BANDS - 1> kBandEnergyCrossCoefficient = {126.0, 115.0,
                                                                                     125.0, 104.0};

static constexpr std::array<float, MAX_NUM_BANDS> kBassBoostEnergyCrossCoefficient = {
        221.21, 208.10, 28.16, 0.0, 0.0};

static constexpr float kBassBoostEnergyCoefficient = 9.00;

static constexpr float kVirtualizerContribution = 1.9;
