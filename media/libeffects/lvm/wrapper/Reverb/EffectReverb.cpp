...
int16_t ReverbConvertLevel(int16_t level) {
    static int16_t LevelArray[101] = {
        -12000, -4000, -3398, -3046, -2796, -2603, -2444, -2310, -2194, -2092, -2000, -1918, -1842,
        -1773,  -1708, -1648, -1592, -1540, -1490, -1443, -1398, -1356, -1316, -1277, -1240, -1205,
        -1171,  -1138, -1106, -1076, -1046, -1018, -990,  -963,  -938,  -912,  -888,  -864,  -841,
        -818,   -796,  -775,  -754,  -734,  -714,  -694,  -675,  -656,  -638,  -620,  -603,  -585,
        -568,   -552,  -536,  -520,  -504,  -489,  -474,  -459,  -444,  -430,  -416,  -402,  -388,
        -375,   -361,  -348,  -335,  -323,  -310,  -298,  -286,  -274,  -262,  -250,  -239,  -228,
        -216,   -205,  -194,  -184,  -173,  -162,  -152,  -142,  -132,  -121,  -112,  -102,  -92,
        -82,    -73,   -64,   -54,   -45,   -36,   -27,   -18,   -9,    0};
    int16_t i;
    ...
    switch (cmdCode) {
        case EFFECT_CMD_INIT:
            ...
            if (pReplyData == NULL || replySize == NULL || *replySize != sizeof(int)) {
                ALOGV(
                    "\tLVM_ERROR : Reverb_command cmdCode Case: "
        ...
        case EFFECT_CMD_SET_PARAM: {
            ...
            if (p->psize != sizeof(int32_t)) {
                ALOGV(
                    "\t4LVM_ERROR : Reverb_command cmdCode Case: "
        ...
        case EFFECT_CMD_SET_VOLUME:
            ...
            if (pReplyData != NULL) {  // we have volume control
                ...
                pContext->rightVolume =
                    (LVM_INT16)((*((uint32_t *)pCmdData + 1) + (1 << 11)) >> 12);
