...
using aidl::android::hardware::audio::effect::AuxEnvReverbImplUUID;
using aidl::android::hardware::audio::effect::AuxPresetReverbImplUUID;
using aidl::android::hardware::audio::effect::Descriptor;
using aidl::android::hardware::audio::effect::EffectReverb;
using aidl::android::hardware::audio::effect::IEffect;
using aidl::android::hardware::audio::effect::InsertEnvReverbImplUUID;
using aidl::android::hardware::audio::effect::InsertPresetReverbImplUUID;
using aidl::android::hardware::audio::effect::State;
using aidl::android::media::audio::common::AudioUuid;

bool isReverbUuidSupported(const AudioUuid* uuid) {
    return (*uuid == AuxEnvReverbImplUUID() || *uuid == InsertEnvReverbImplUUID() ||
            *uuid == AuxPresetReverbImplUUID() || *uuid == InsertPresetReverbImplUUID());
}
