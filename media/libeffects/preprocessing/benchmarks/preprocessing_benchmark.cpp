...
#ifndef WEBRTC_LEGACY
constexpr unsigned int kAecMobileMode = 1;
#endif
...
#ifndef WEBRTC_LEGACY
  if (PREPROC_AECM == effectType) {
    if (int status = preProcSetConfigParam(AEC_PARAM_MOBILE_MODE,
                                           kAecMobileMode, effectHandle);
        status != 0) {
