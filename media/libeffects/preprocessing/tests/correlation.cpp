...
int main(int argc, const char* argv[]) {
    ...
    std::unique_ptr<int16_t[]> inBuffer1(new int16_t[fileSize1 / sizeof(int16_t)]());
    std::unique_ptr<int16_t[]> inBuffer2(new int16_t[fileSize2 / sizeof(int16_t)]());

    fread(inBuffer1.get(), sizeof(int16_t), fileSize1 / sizeof(int16_t), fInput1.get());
    fread(inBuffer2.get(), sizeof(int16_t), fileSize2 / sizeof(int16_t), fInput2.get());

    float maxAutoCorr1 = 0.0f, maxAutoCorr2 = 0.0f;
    int delayAutoCorr1 =
            correlation(inBuffer1.get(), inBuffer1.get(), fileSize1 / sizeof(*inBuffer1.get()),
                        &maxAutoCorr1, enableCrossCorr);
    int delayAutoCorr2 =
            correlation(inBuffer2.get(), inBuffer2.get(), fileSize2 / sizeof(*inBuffer2.get()),
    ...
    if (enableCrossCorr) {
        ...
        int delayCrossCorr =
                correlation(inBuffer1.get(), inBuffer2.get(), fileSize1 / sizeof(*inBuffer1.get()),
