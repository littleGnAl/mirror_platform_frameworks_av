...
status_t aidl2legacy_AudioDevice_audio_device(const media::audio::common::AudioDevice& aidl,
...
ConversionResult<audio_uuid_t> aidl2legacy_AudioUuid_audio_uuid_t(const AudioUuid& aidl);
ConversionResult<AudioUuid> legacy2aidl_audio_uuid_t_AudioUuid(const audio_uuid_t& legacy);
