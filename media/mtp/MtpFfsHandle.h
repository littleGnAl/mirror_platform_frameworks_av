...
private:
    ...
    android::base::unique_fd mBulkIn;  /* "in" from the host's perspective => sink for mtp server */
    android::base::unique_fd mBulkOut; /* "out" from the host's perspective => source for mtp server */
