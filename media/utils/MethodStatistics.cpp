...
// It's important to have the class name defined with suffix "Hidl/Aidl" because this string is used
// by TimerThread::isRequestFromHal to match binder call to/from hal.
