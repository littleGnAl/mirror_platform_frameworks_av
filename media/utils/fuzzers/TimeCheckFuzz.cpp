...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    uint32_t timeout = data_provider.ConsumeIntegralInRange<uint32_t>(kMinTimeout, kMaxTimeout);
    ...
    uint8_t sleep_amount = data_provider.ConsumeIntegralInRange<uint8_t>(0, timeout / 2);
