...
public:
    ...
    virtual sp<IMediaExtractor> makeExtractor(const sp<IDataSource> &source, const char *mime, const Vector<uint8_t> *drmUuid = NULL, const Vector<uint8_t> *sessionId = NULL);
