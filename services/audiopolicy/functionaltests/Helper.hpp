...
public:
    ...
    static bool connectPort(const audio_port_v7 &portToConnect, audio_port_v7 &connectedPort);

    static std::vector<audio_port_v7> getAvailablePorts();

    static bool isPortConnected(const audio_port_v7 &port);

    static bool disconnectPort(const audio_port_v7 &portToConnect);
    ...
    static std::string dumpPort(const audio_port_v7 &port);
    ...
    static android::status_t findPort(const audio_port_v7 &expectedPort, audio_port_v7 &foundPort);
    ...
    static void getPort(audio_devices_t type, const std::string &address, audio_port_v7 &port);
    ...
    static audio_port_handle_t checkPatch(audio_io_handle_t mixHandle);
    ...
    static void checkEstablishedPatch(const audio_patch &patch, const audio_port_v7 &sourcePort,
                                      const audio_port_v7 &sinkPort,
    ...
    static bool checkEstablishedPatch(const audio_patch_handle_t &audioPatchHandle,
                                      ...
                                      bool useSwBridge, audio_stream_type_t streamType);
    static void checkEstablishedPatch(const audio_port_v7 &sourcePort, const audio_port_v7 &sinkPort,
                                      bool useSwBridge, audio_stream_type_t streamType);

    static bool checkPatchRemoved(
            const audio_port_v7 &sourcePort, const audio_port_v7 &sinkPort,
    ...
    static void playbackOnExplicitDevice(const audio_port_v7 &explicitDevicePort,
                                         audio_port_handle_t &routedPort);

    static void captureFromExplicitDevice(const audio_port_v7 &explicitDevicePort,
                                          audio_port_handle_t &routedPort);
