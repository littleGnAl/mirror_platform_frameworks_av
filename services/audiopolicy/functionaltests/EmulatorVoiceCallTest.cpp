...
using VoiceCallBridgeTestParams =
    std::tuple<const audio_attributes_t /*renderingAttributes*/,
        const audio_port_v7 /*txSourcePort*/,
        const audio_source_t /* sourceUseCase*/,
        const audio_port_v7 /*txSinkPort*/,
        ...
        const audio_port_v7 /*rxSourcePort*/,
        const audio_source_t /* sourceUseCase*/,
        const audio_port_v7 /*rxSinkPort*/,
...
TEST_P(VoiceCallBridgingTest, UsingSetPhoneStateAPI)
{
    ...
    const audio_port_v7 expectedTxSourcePort = std::get<1>(GetParam());
    (void) std::get<2>(GetParam());
    const audio_port_v7 expectedTxSinkPort = std::get<3>(GetParam());
    ...
    const audio_port_v7 expectedRxSourcePort = std::get<7>(GetParam());
    (void) std::get<8>(GetParam());
    const audio_port_v7 expectedRxSinkPort = std::get<9>(GetParam());
    ...
    audio_port_v7 txSourcePort {};
    audio_port_v7 txSinkPort {};
    audio_port_v7 rxSourcePort {};
    audio_port_v7 rxSinkPort {};
