...
TEST_P(AudioSourceBridgingTest, UsingAudioSourceAPI)
{
    ...
    const audio_port_v7 expectedSourcePort = std::get<1>(GetParam());
    (void) std::get<2>(GetParam());
    const audio_port_v7 expectedSinkPort = std::get<3>(GetParam());
...
const audio_port_v7 /*sourcePort*/,
const audio_port_v7 /*sinkPort*/,
const audio_port_v7 /*forcedUseToggledSinkPort*/,
const audio_stream_type_t /*sinkStream*/,
...
TEST_P(AudioSourceForceUseTogglingTest, SetForceUseToggling)
{
    ...
    const audio_attributes_t attributes = std::get<0>(GetParam());
    const audio_port_v7 expectedSourcePort = std::get<1>(GetParam());
    const audio_port_v7 expectedSinkPort = std::get<2>(GetParam());
    const audio_port_v7 forceUseExpectedSinkPort = std::get<3>(GetParam());
    const audio_stream_type_t expectedStreamType = std::get<4>(GetParam());
    ...
    audio_port_v7 sourcePort {};
    audio_port_v7 sinkPort {};
    audio_port_v7 sinkPortForcedConfig {};
