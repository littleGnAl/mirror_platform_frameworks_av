...
TEST_P(AudioSourceBridgingTest, UsingAudioSourceAPI)
{
    ...
    auto connectAudioSource = [&]() {
        ...
        ret = AudioSystem::startAudioSource(&sourcePortConfig,
                                            &attributes,
                                            &sourcePortHandle);
        EXPECT_EQ(android::OK, ret) << "AudioSystem::startAudioSource for source "
    ...
    auto releaseAudioSource = [&]() {
        ...
        if (sourcePortHandle != AUDIO_PORT_HANDLE_NONE) {
            ...
            EXPECT_EQ(android::OK, ret) << "AudioSystem::stopAudioSource for handle "
    ...
    disconnectDevice();
    checkPatchRemoved();
    EXPECT_EQ(android::BAD_VALUE, AudioSystem::stopAudioSource(sourcePortHandle))
...
TEST_P(AudioSourceForceUseTogglingTest, SetForceUseToggling)
{
    ...
    auto connectAudioSource = [&]() {
        ...
        ret = AudioSystem::startAudioSource(&sourcePortConfig,
                                            &attributes,
                                            &sourcePortHandle);
        EXPECT_EQ(android::OK, ret) << "AudioSystem::startAudioSource for "
