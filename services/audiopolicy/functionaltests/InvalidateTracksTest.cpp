...
INSTANTIATE_TEST_CASE_P(
        ...
        ::testing::Values(
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC, AUDIO_USAGE_MEDIA,
                                       AUDIO_SOURCE_DEFAULT, 0, ""}, false),
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC, AUDIO_USAGE_ALARM,
                                       AUDIO_SOURCE_DEFAULT, 0, ""}, false),
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC,
                                       AUDIO_USAGE_ASSISTANCE_ACCESSIBILITY,
                                       AUDIO_SOURCE_DEFAULT, 0, ""}, true),
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC, AUDIO_USAGE_NOTIFICATION,
                                       AUDIO_SOURCE_DEFAULT, 0, ""}, false),
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC,
            ...
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC,
                                       ...
                                       AUDIO_SOURCE_DEFAULT, 0, ""}, false),
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC, AUDIO_USAGE_GAME,
                                       AUDIO_SOURCE_DEFAULT, 0, ""}, false),
            InvalidateTrackTestParams({AUDIO_CONTENT_TYPE_MUSIC, AUDIO_USAGE_ASSISTANT,
                                       AUDIO_SOURCE_DEFAULT, 0, ""}, false)
            )
        );
...
INSTANTIATE_TEST_CASE_P(
        ...
        ::testing::Values(
            ...
            SetForceUseInvalidateTracksTestParams(
               ...
               {attributes_initializer(AUDIO_USAGE_ASSISTANCE_SONIFICATION), true}),
            SetForceUseInvalidateTracksTestParams(
               {attributes_initializer_flags(
                 static_cast<audio_flags_mask_t>(AUDIO_FLAG_AUDIBILITY_ENFORCED)), true},
               {attributes_initializer(AUDIO_USAGE_MEDIA), false}),
            SetForceUseInvalidateTracksTestParams(
               {attributes_initializer_flags(
                 static_cast<audio_flags_mask_t>(AUDIO_FLAG_AUDIBILITY_ENFORCED)), true},
