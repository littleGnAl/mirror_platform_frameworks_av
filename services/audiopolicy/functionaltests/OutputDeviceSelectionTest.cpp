                                                              ...
                                                              audio_devices_t device )
{
    ...
    ASSERT_EQ(android::OK, test->createTrack()) << "Failed to create AudioTrack";
    ...
    ASSERT_EQ(AUDIO_PORT_TYPE_DEVICE, portConfig.type)
            ...
            << portConfig.type;
    std::string deviceLiteral(android::toString(portConfig.ext.device.type));
    std::string expectedDeviceLiteral(android::toString(device));;
...
TEST_P(SelectedOutputDeviceTest, Output)
{
    ...
    std::string addedDeviceLiteral(android::toString(addedDevice));
...
TEST_P(ForceScoSelectedOutputDeviceTest, Output)
{
    ...
    android::AudioSystem::setForceUse(AUDIO_POLICY_FORCE_FOR_COMMUNICATION,
                                      AUDIO_POLICY_FORCE_BT_SCO);
    android::AudioSystem::setForceUse(AUDIO_POLICY_FORCE_FOR_VIBRATE_RINGING,
                                      AUDIO_POLICY_FORCE_BT_SCO);
    Helper::changeMode(mode);
    getOutputForAttrAndCheckDevice(attr, expectedDevice);
    android::AudioSystem::setForceUse(AUDIO_POLICY_FORCE_FOR_COMMUNICATION,
...
TEST_P(ForceNoBtA2dpSelectedOutputDeviceTest, Output)
{
    ...
    android::AudioSystem::setForceUse(AUDIO_POLICY_FORCE_FOR_MEDIA, AUDIO_POLICY_FORCE_NO_BT_A2DP);
    Helper::changeMode(mode);
    getOutputForAttrAndCheckDevice(attr, expectedDevice);
    android::AudioSystem::setForceUse(AUDIO_POLICY_FORCE_FOR_MEDIA, AUDIO_POLICY_FORCE_NONE);
...
TEST_P(ForceSpeakerSelectedOutputDeviceTest, Output)
{
    ...
    android::AudioSystem::setForceUse(AUDIO_POLICY_FORCE_FOR_MEDIA, AUDIO_POLICY_FORCE_SPEAKER);
    android::AudioSystem::setForceUse(AUDIO_POLICY_FORCE_FOR_COMMUNICATION,
