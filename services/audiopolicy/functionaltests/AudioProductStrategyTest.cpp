...
static void playbackFollowingProductStrategy(
        const product_strategy_t strategy, audio_port_v7 &routedDevicePort,
...
static void playbackForAttributes(
        const audio_attributes_t attributes, audio_port_v7 &routedDevicePort,
        const audio_port_handle_t expectedPort = AUDIO_PORT_HANDLE_NONE)
{
...
static void playbackForStream(audio_stream_type_t stream, audio_port_v7 &routedDevicePort,
                              const audio_port_handle_t expectedPort = AUDIO_PORT_HANDLE_NONE)
{
...
TEST_P(AudioProductStrategyTest, DeviceSelection)
{
    ...
    auto strategy = *iter;
    audio_port_v7 routedDeviceAudioPort;
...
TEST_P(ConcurrencyTest, Concurrency)
{
    ...
    audio_port_v7 expectedRoutedPort1;
    ...
    audio_port_v7 expectedRoutedPort2;
