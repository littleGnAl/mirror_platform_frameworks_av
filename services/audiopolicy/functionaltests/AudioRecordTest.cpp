...
void AudioRecordTest::AudioRecordCallback(int event, void *user, void *info) {
    ...
    case android::AudioRecord::EVENT_MORE_DATA: {
        android::AudioRecord::Buffer *buffer = (android::AudioRecord::Buffer *)info;
...
android::status_t AudioRecordTest::recordToFile(audio_port_handle_t &routedPortId,
...
android::status_t AudioRecordTest::record(audio_port_handle_t &routedPortId)
{
    android::status_t status = mAudioRecord->start();
...
android::status_t AudioRecordTest::stop()
{
    mAudioRecord->stop();
...
android::status_t AudioRecordTest::createAudioRecord()
{
    android::status_t status;
    android::String16 opPackageName;
    size_t frames;
    status = android::AudioRecord::getMinFrameCount(&frames,
    ...
    mAudioRecord = new android::AudioRecord(opPackageName);
    ...
    mAudioRecord->set(mAudioAttributes.source,
                     ...
                     android::AudioRecord::transfer_type::TRANSFER_DEFAULT, //streamTransferType,
