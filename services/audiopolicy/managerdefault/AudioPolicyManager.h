...
protected:
         ...
         * associated to default volume source, e.g. music. Thus, any change of call of volume API
         * using this translation function will affect the default volume source.
