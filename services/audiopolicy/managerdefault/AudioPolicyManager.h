...
private:
        /**
         * @brief isAudioPatchValid checks if the given patch structure is valid/supported
         * (e.g. only one source per audio patch supported for now)
         * @param patch
         ...
         * @param[in] sourceDesc whatever internal or external source, source client to be
