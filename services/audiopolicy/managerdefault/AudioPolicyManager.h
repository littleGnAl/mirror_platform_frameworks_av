...
private:
        ...
        /**
         * @brief createAudioPatchInt internal function to manage audio patch creation
         ...
         * @param[out] uid of the client
         * @param[out] delayMs if required
         * @param[in,out] sourceDesc [optional] in case of external source, source client to be
         ...
         */
        status_t createAudioPatchInt(const struct audio_patch *patch,
                                     audio_patch_handle_t *handle,
                                     uid_t uid, uint32_t delayMs,
                                     const sp<SourceClientDescriptor>& sourceDesc = nullptr);
        /**
         * @brief releaseAudioPatchInt internal function to remove an audio patch
         * @param handle of the patch to be removed
         * @return NO_ERROR if patch removed correclty, error code otherwise.
         */
        status_t releaseAudioPatchInt(audio_patch_handle_t handle);
