...
AudioSession::~AudioSession() {
    // When closeInput/releaseInput may be called without stopInput
    // In this situation, there will always be an recorder recorded in RecordingActivityMonitor.
    // When destructor was call, should try to notiy RecordingActivityMonitor
    // to update RecordingConfiguration.
    if (mActiveCount > 0) {
