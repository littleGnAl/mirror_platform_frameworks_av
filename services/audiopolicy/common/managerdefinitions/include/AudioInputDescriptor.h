...
public:
     ...
     * When an input is shared amoung several clients, (e.g. hotword and ordinary app), the ordinary
     * app configuration may be taken in prior to prevent from signal deterioration.
     * This APIs allows to force AudioFlinger applying the new configuration of either the lastest
