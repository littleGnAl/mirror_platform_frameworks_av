            ...
            if component_type.get('Name') == component_types_name:
                ...
                if bitparameters_node is not None:
                    ...
                    for key, value in ordered_values.items():
                        ...
                        # TODO: b/168065706. This is just to fix the build. That the problem of
                        # devices with multiple bits set must be addressed more generally in the
                        # configurable audio policy and parameter framework.
