...
struct ResourceList {
    ...
    bool add(const ::aidl::android::media::MediaResourceParcel& res, bool& isNewEntry);
    ...
    bool remove(const ::aidl::android::media::MediaResourceParcel& res, long& removedEntryValue);
    ...
    // Add or Update an entry into ResourceList.
    void add(const ::aidl::android::media::MediaResourceParcel& res);
