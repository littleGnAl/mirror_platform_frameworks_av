...
public:
    ...
    void testConcurrentCodecs() {
        ...
        long currentPixelCountP1 = mService->getConcurrentPixelCount(kTestPid1);
        ...
        currentPixelCountP1 = mService->getConcurrentPixelCount(kTestPid1);
        EXPECT_TRUE(peakPixelCountP1 == client1Config.width * client1Config.height);
        ...
        long currentPixelCountP2 = mService->getConcurrentPixelCount(kTestPid2);
        EXPECT_TRUE(peakPixelCountP1 == client1Config.width * client1Config.height);
        EXPECT_TRUE(currentPixelCountP1 == client1Config.width * client1Config.height);
        ...
        currentPixelCountP2 = mService->getConcurrentPixelCount(kTestPid2);
        EXPECT_TRUE(peakPixelCountP1 ==
            (client1Config.width * client1Config.height + client4Config.width * client4Config.height));
        EXPECT_TRUE(currentPixelCountP1 ==
            (client1Config.width * client1Config.height + client4Config.width * client4Config.height));
        EXPECT_TRUE(peakPixelCountP2 ==
            (client2Config.width * client2Config.height + client3Config.width * client3Config.height));
