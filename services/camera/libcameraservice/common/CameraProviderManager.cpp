...
bool CameraProviderManager::isPublicallyHiddenSecureCameraLocked(const std::string& id) {
    auto deviceInfo = findDeviceInfoLocked(id);
    if (deviceInfo != nullptr) {
...
CameraProviderManager::isHiddenPhysicalCameraInternal(const std::string& cameraId) {
