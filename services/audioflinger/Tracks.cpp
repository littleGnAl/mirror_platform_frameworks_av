...
AudioFlinger::PlaybackThread::PatchTrack::PatchTrack(PlaybackThread *playbackThread,
                                                     ...
                                                     void *buffer,
                                                     size_t bufferSize,
                                                     const AttributionSourceState& clientAttSource,
                                                     audio_output_flags_t flags,
                                                     const Timeout& timeout,
                                                     size_t frameCountToBeReady)
                       ...
                       *playbackThread, timeout)
{
    ...
    mPatchTrackPlayer = new PatchTrackPlayerBase(
            this, AudioSystem::streamTypeToAttributes(streamType).usage, clientAttSource);
}
      ...
      mPatchTrack(*patchTrack), mPlayerVolumeL(1.0f), mPlayerVolumeR(1.0f)
{
    ...
    PlayerBase::init(
                PLAYER_TYPE_HW_SOURCE_SW_BRIDGE, usage, AUDIO_SESSION_NONE, clientAttSource.uid);
}
...
binder::Status AudioFlinger::PlaybackThread::PatchTrackPlayerBase::applyVolumeShaper(
        ...
        const ::android::media::VolumeShaperOperation& operation) {
