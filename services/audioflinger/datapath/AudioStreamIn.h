...
public:
    ...
    virtual ~AudioStreamIn() override;

    virtual status_t getCapturePosition(int64_t* frames, int64_t* time) override;

    virtual status_t read(void* buffer, size_t bytes, size_t* read) override;
    ...
    virtual status_t standby() override;
