...
status_t AudioFlinger::DeviceEffectManager::checkEffectCompatibility(
    ...
    // We can trust AIDL generated AudioHalVersion comparision operator (based on std::tie) as long as the type,
    // major and minor sequence doesn't change in the definition.
