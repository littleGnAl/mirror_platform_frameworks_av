...
{
    wp<AudioFlinger::PlaybackThread> mThreadCallback = this;
    std::thread([this, metadataBs, mThreadCallback]() {
            sp<AudioFlinger::PlaybackThread> playbackThread = mThreadCallback.promote();
