        ...
        const std::shared_ptr<mediametrics::StatsdLog>& statsdLog)
{
    ...
    int32_t hdr10PlusInfoExist = -1;
    if (item->getInt32("android.media.mediacodec.hdr10-plus-info-exist", &hdr10PlusInfoExist)) {
        metrics_proto.set_hdr10_plus_info_exist(hdr10PlusInfoExist);
    }
    AStatsEvent_writeInt32(event, hdr10PlusInfoExist);
