        ...
        const std::shared_ptr<mediametrics::StatsdLog>& statsdLog)
{
    ...
    int32_t hdrStaticInfoExistence = -1;
    if (item->getInt32("android.media.mediacodec.hdr-static-info-existence", &hdrStaticInfoExistence)) {
        metrics_proto.set_hdr_static_info_existence(hdrStaticInfoExistence);
    }
    AStatsEvent_writeInt32(event, hdrStaticInfoExistence);
