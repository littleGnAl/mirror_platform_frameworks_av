...
#define	MM_PREFIX "android.media.audiothread."
    ...
    int result = mediametrics::stats::stats_write(mediametrics::stats::MEDIAMETRICS_AUDIOTHREAD_REPORTED,
    ...
    log << "result:" << result << " {"
            ...
            << mediametrics::stats::MEDIAMETRICS_AUDIOTHREAD_REPORTED
            ...
            << " }";
    statsdLog->log(mediametrics::stats::MEDIAMETRICS_AUDIOTHREAD_REPORTED, log.str());
    return true;
}
