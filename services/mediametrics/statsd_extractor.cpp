        ...
        const std::shared_ptr<mediametrics::StatsdLog>& statsdLog)
{
    ...
    int result = mediametrics::stats::stats_write(mediametrics::stats::MEDIAMETRICS_EXTRACTOR_REPORTED,
    ...
    log << "result:" << result << " {"
            ...
            << mediametrics::stats::MEDIAMETRICS_EXTRACTOR_REPORTED
            ...
            << " }";
    statsdLog->log(mediametrics::stats::MEDIAMETRICS_EXTRACTOR_REPORTED, log.str());
    return true;
}
