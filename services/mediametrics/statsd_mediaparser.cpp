        ...
        const std::shared_ptr<mediametrics::StatsdLog>& statsdLog)
{
    ...
    int result = mediametrics::stats::stats_write(mediametrics::stats::MEDIAMETRICS_MEDIAPARSER_REPORTED,
                               timestamp_nanos,
                               package_name.c_str(),
    ...
    log << "result:" << result << " {"
            ...
            << mediametrics::stats::MEDIAMETRICS_MEDIAPARSER_REPORTED
            ...
            << " }";
    statsdLog->log(mediametrics::stats::MEDIAMETRICS_MEDIAPARSER_REPORTED, log.str());
    return true;
}
