        ...
        const std::shared_ptr<mediametrics::StatsdLog>& statsdLog)
{
    ...
    mediametrics::stats::BytesField bf_serialized(kUnusedField.c_str(), kUnusedField.size());
    int result = mediametrics::stats::stats_write(mediametrics::stats::MEDIAMETRICS_MEDIADRM_REPORTED,
    ...
    log << "result:" << result << " {"
            ...
            << mediametrics::stats::MEDIAMETRICS_MEDIADRM_REPORTED
            ...
            // omitting serialized
            << " }";
    statsdLog->log(mediametrics::stats::MEDIAMETRICS_MEDIADRM_REPORTED, log.str());
    return true;
}
        ...
        const std::shared_ptr<mediametrics::StatsdLog>& statsdLog)
{
    ...
    const int result = mediametrics::stats::stats_write(mediametrics::stats::MEDIAMETRICS_DRMMANAGER_REPORTED,
                               timestamp_nanos, package_name.c_str(), package_version_code,
                               media_apex_version,
    ...
    log << "result:" << result << " {"
            ...
            << mediametrics::stats::MEDIAMETRICS_DRMMANAGER_REPORTED
            << " timestamp_nanos:" << timestamp_nanos
            << " package_name:" << package_name
            << " package_version_code:" << package_version_code
            << " media_apex_version:" << media_apex_version
    ...
    log << " }";
    statsdLog->log(mediametrics::stats::MEDIAMETRICS_DRMMANAGER_REPORTED, log.str());
    return true;
}
        ...
        const std::shared_ptr<mediametrics::StatsdLog>& statsdLog)
{
    ...
    AStatsEvent_setAtomId(event, mediametrics::stats::MEDIA_DRM_ACTIVITY_INFO);
    ...
    log << "pulled:" << " {"
            ...
            << mediametrics::stats::MEDIA_DRM_ACTIVITY_INFO
            ...
            << " }";
    statsdLog->log(mediametrics::stats::MEDIA_DRM_ACTIVITY_INFO, log.str());
    return true;
}
