...
void AudioPowerUsage::sendItem(const std::shared_ptr<const mediametrics::Item>& item) const
{
    ...
    const int result = mediametrics::stats::stats_write(mediametrics::stats::AUDIO_POWER_USAGE_DATA_REPORTED,
                                         audio_device,
                                         duration_secs,
                                         (float)volume,
                                         type,
    ...
    log << "result:" << result << " {"
            ...
            << mediametrics::stats::AUDIO_POWER_USAGE_DATA_REPORTED
            ...
            << " }";
    mStatsdLog->log(mediametrics::stats::AUDIO_POWER_USAGE_DATA_REPORTED, log.str());
}
