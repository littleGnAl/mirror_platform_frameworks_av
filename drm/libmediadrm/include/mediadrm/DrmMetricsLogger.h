...
enum {
    kSecurityLevelUnknown = 0,
    kSecurityLevelSwSecureCrypto = 1,
    kSecurityLevelSwSecureDecode = 2,
    kSecurityLevelHwSecureCrypto = 3,
    kSecurityLevelHwSecureDecode = 4,
    kSecurityLevelHwSecureAll = 5,
    kSecurityLevelMax = 6,
};
