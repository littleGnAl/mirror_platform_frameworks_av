...
struct DrmHalAidl : public IDrm{
    ...
    virtual DrmStatus restoreKeys(Vector<uint8_t> const& sessionId, Vector<uint8_t> const& keySetId);
    ...
    virtual DrmStatus setCipherAlgorithm(Vector<uint8_t> const& sessionId, String8 const& algorithm);
    ...
    virtual DrmStatus requiresSecureDecoder(const char* mime, DrmPlugin::SecurityLevel securityLevel,
                                           bool* required) const;
