...
ScopedAStatus DrmRemotelyProvisionedComponent::generateEcdsaP256KeyPair(
...
std::string DrmRemotelyProvisionedComponent::getDrmPropertyString(
        const std::string& in_propertyName) const {
    std::string ret = "";
