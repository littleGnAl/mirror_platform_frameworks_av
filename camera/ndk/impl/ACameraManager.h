...
class CameraManagerGlobal final : public RefBase {
  ...
  private:
    ...
    struct StatusAndHAL3 {
        int32_t status = hardware::ICameraServiceListener::STATUS_NOT_PRESENT;
        bool supportsHAL3 = false;
        StatusAndHAL3(int32_t st, bool HAL3support): status(st), supportsHAL3(HAL3support) { };
        StatusAndHAL3() = default;
    };

    // Map camera_id -> status
    std::map<String8, StatusAndHAL3, CameraIdComparator> mDeviceStatusMap;
